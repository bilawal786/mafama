        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-20">
                    <li class="active"><a href="{{ url('schedule_birthday') }}">Schedule Birthday</a></li>
                    <li><a href="{{ url('schedule_holiday') }}">Schedule Holiday</a></li>
                </ul>
                ...
                if($(".summernote2").code() == ""){
                    ...
                    if(submit_value == "Send"){
                        $.ajax({
                          ...
                          url: "schedule_birthday_card_submit",
                          data:  formData,
                            contentType: false,
                            cache: false,
                            processData:false,
                ...
                if($(".summernote3").code() == ""){
                    ...
                    if(submit_value == "Send"){
                        $.ajax({
                          ...
                          url: "schedule_birthday_video_submit",
                          data:  formData,
                            contentType: false,
                            cache: false,
                            processData:false,
