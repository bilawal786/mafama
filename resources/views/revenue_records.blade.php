                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" style="margin-bottom: 20px;{{ $dnone }}">
                                            ...
                                            <div style="">
                                                <div class="">
                                                    <label class="checkbox chk-sm ">
                                                        <input class="" type="checkbox" disabled name="tax1" value="{{ isset($invoice_setup->id)?$invoice_setup->tax_rate:0 }}" <?php if($invoice_setup->is_tax == 1){ ?>checked <?php }else{ ?> readonly <?php } ?> onchange="tax_calc()" />
                                                        <i></i> Tax
                                                    </label>
                                        ...
                                        <div class="col-md-3" style="margin-bottom: 20px;{{ $dnone1 }}">
                                             <div style="">
                                                 <div class="">
                                                <label class="checkbox chk-sm">
                                                  <input class="" type="checkbox" disabled name="shipping1" value="{{ isset($invoice_setup->id)?$invoice_setup->shipping_rate:0}}" <?php if($invoice_setup->shipping_cost == 1){ ?>checked <?php } else{ ?> readonly <?php } ?> onchange="tax_calc()" />
                                                            <i></i> Shipping
