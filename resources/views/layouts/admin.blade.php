                        ...
                        <div class="nk-sidebar-content">
                            <div class="nk-sidebar-menu" data-simplebar>
                                <ul class="nk-menu">
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                           @if(permission_access1('access_role')==1)
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/affilates_registration') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/registered_business') }}" class="nk-menu-link">
                                            ...
                                            @if(permission_access1('registration_requests')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin/affilates_registration_enquiry') }}" class="nk-menu-link">
                                            ...
                                            @if(permission_access1('earning_points')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('earning-point-setting') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('lead-qualifier-setting') }}" class="nk-menu-link">
                                        ...
                                        @if(permission_access1('search_and_send_email')==1)
                                         ...
                                         @if(permission_access1('search_and_send_email')==1)
                                          <li class="nk-menu-item">
                                                <a href="{{ url('fix-commission-setting') }}" class="nk-menu-link">
                                    ...
                                    @endif
                                    <!-- @if(permission_access1('adminrole_view')==1 || permission_access1('roles_view')==1 || permission_access1('admin_list_view')==1)
                                    <li class="nk-menu-item has-sub">
                                        <a href="#" class="nk-menu-link nk-menu-toggle" data-original-title="" title="">
                                            <span class="nk-menu-icon"><em class="icon ni ni-puzzle-fill"></em></span>
                                 ...
                                 <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            @if(permission_access1('affiliate_email_template')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('affiliate-email-template') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('client-registration-email-template') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('business-registration-email-template') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('record-transactions-email-template') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('minus-balance-email-template') }}" class="nk-menu-link">
                                     ...
                                     <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                          <!--  <li class="nk-menu-item">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/nonaffiliates_registration') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                         ...
                                         <!--   <li class="nk-menu-item">
                                            ...
                                            @if(permission_access1('home_page_videos')==1)
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/home_top_videos') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @if(permission_access1('home_page_video_main')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin/home_main_videos') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                ...
                                @if(permission_access1('site_banners_views')==1)
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/appointment_banner') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/client_management_banner') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/email_management_banner') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/financial_management_banner') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/archives_banner') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                ...
                                @if(permission_access1('site_videos_views')==1)
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/introduction-videos') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/setting_tutorials') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/appoitment_tutorials') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/client_tutorials') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/email_tutorials') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/finance_tutorials') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/archive_tutorials') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            @if(permission_access1('create_category_popup')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin_category_popup1') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                  ...
                                  @if(permission_access1('templates_views')==1)
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('create_template_category') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                          ...
                                          <!--   <li class="nk-menu-item">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin_upload_template_category') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin_upload_financial_template_category') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @if(permission_access1('upload_balancesheet_templates')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin_upload_balancesheet_template_category') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                   ...
                                   @if(permission_access1('create_categories_views')==1)
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin_script_category') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin_business_category') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin_personalised_greeting') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin_upload_business') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                                    <span class="nk-menu-text">Business </span>
                                                </a>
                                            </li>
                            ...
                            <a href="#" class="nk-menu-link nk-menu-toggle" data-original-title="" title="">
                              ...
                              <ul class="nk-menu-sub">
                                ...
                                @foreach($lead_menu as $menu)
                                   <li class="nk-menu-item">
                                    <a href="{{ url('leads-by-category/'.str_replace (' ','-',strtolower($menu->id))) }}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                        <span class="nk-menu-text">{{ $menu->category }}({{ \App\UploadLeads::total_leads($menu->id)}}) </span>
                                    </a>
                                </li>
                                @endforeach
                                @endif
                                ...
                                @endif
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        @if(permission_access1('affiliate_commission_setting')==1)
                                            <li class="nk-menu-item">
                                                <a href="{{ url('affiliate_commission_setting') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('bonus_condition_table') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @if(permission_access1('bonus_pool_prize_setting')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('bonus-pool-price-list') }}" class="nk-menu-link">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('prize_condition_table') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @endif
                                             ...
                                             <li class="nk-menu-item">
                                                <a href="{{ url('other_condition_table') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                             ...
                                             <li class="nk-menu-item">
                                                <a href="{{ url('affiliates_promotion_condition') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            @if(permission_access1('notifications_cms')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin/notification-cms') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-bell"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            @if(permission_access1('bonus_income_report')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin/bonus-income-report') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @if(permission_access1('level_income_report')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin/level-income-report') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @if(permission_access1('transactions')==1)
                                             <li class="nk-menu-item">
                                                <a href="{{ url('admin/transaction-history') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                         ...
                                         <li class="nk-menu-item">
                                                <a href="{{ url('genealogy_report') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                        ...
                        @if(permission_access1('feature_views')==1)
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('affilate_features_access') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('gold_features_access') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('sliver_features_access') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('enterprises_feature_access') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                    ...
                    @if(permission_access1('front_editing_views')==1)
                                     <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('financial_mgmt_front') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                        ...
                        @endif
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                                <a href="{{ url('upload_arrondissements') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            ...
                                            <li class="nk-menu-item">
                                             <a href="{{ url('admin_survey_polls') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                            ...
                                            @if(permission_access1('survey_result')==1)
                                             <li class="nk-menu-item">
                                             <a href="{{ url('admin_user_records') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
                                    ...
                                    <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                         @if(permission_access1('upload')==1)
                                            <li class="nk-menu-item">
                                                <a href="{{ url('admin/terms_conditions') }}" class="nk-menu-link">
                                                    <span class="nk-menu-icon"><em class="icon ni ni-forward-arrow-fill"></em></span>
