                                                        ...
                                                        <div class="col-md-12 testimonial-bordered">
                                                            ...
                                                            <div class="testimonial-content nopadding">
                                                                ...
                                                                <cite>
                                                                    <?= $slide->username ?>
                                                                    <span
                                                                        class="text-success">New Member</span>{{-- <span><b>$</b><= $slide->amount ></span> --}}
                                                                </cite>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    @if($transactions->count() >0 )
                                        @foreach($transactions as $trans)
                                            <tr>
                                                ...
                                                <td>{{$usr->country ?? ""}}</td>
                                                <td style="width: 15% !important">{{$usr->state ?? ""}} {{$usr->city ?? ""}} {{$usr->commune ?? ""}}</td>
                        ...
                        <div class="col-md-12">
                            ...
                            <ul style="list-style: none; padding: 0; margin-bottom: 0px">
                                ...
                                <li class="affiliate_popup1" style="padding: 10px; float: left; margin-bottom: 10px;"
                                    id="po<?= $value->id ?>">{!! $value->preview !!}</li>
                                <?php
                                }
                                ?>
                            </ul>
