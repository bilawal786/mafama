                    ...
                    <div class="col-md-12" style="padding-bottom: 20px;">
                        ...
                        <div class="col-md-12 margin-bottom-40">
                            <div class="col-md-12 shadow-boxx">
                                        ...
                                        <tbody class="general_form_body">
                                            ...
                                            @endif    
                                                <td>
                                                    ...
                                                    <input type="checkbox" id="general_form" value="{{$form->id}}" @if($count == 'exist') checked  @endif />
                                                        <i></i> {{$form->name}}  
                                                    </label>
                                                </td>   
                                            @if($i == 4) 
                                ...
                                <div class="col-md-12 text-center padding-0">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-info margin-right-40 general_form_submit" style="width: 150px;">SAVE </a>
                        ...
                        <div class="col-md-12 margin-bottom-40">
                            <div class="col-md-12 shadow-boxx">
                                        ...
                                        <tbody class="medical_form_body">
                                         @if(count($medical_forms) > 0) 
                                            ...
                                            @endif    
                                                <td>
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="medical_form" value="{{$form->id}}" @if($count == 'exist') checked  @endif />
                                                        <i></i> {{$form->name}} 
                                                    </label>
                                                </td>   
                                            @if($i == 4) 
                                ...
                                <hr />
                                <div class="col-md-12 text-center padding-0">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-info margin-right-40 medical_form_submit" style="width: 150px;">SAVE </a>
                                   <!--  <a href="#" class="btn btn-xs btn-info" style="width: 150px;">Remove from front</a> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 margin-bottom-40">
                            <div class="col-md-12 shadow-boxx">
                                    ...
                                    <table class="form-info margin-bottom-10" style="width: 100%;">
                                         <tbody class="dentist_form_body">
                                            ...
                                            @endif    
                                                <td>
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="dentist_form" value="{{$form->id}}" @if($count == 'exist') checked  @endif />
                                                        <i></i> {{$form->name}} 
                                                    </label>
                                                </td>   
                                            @if($i == 4) 
                                ...
                                <hr />
                                <div class="col-md-12 text-center padding-0">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-info margin-right-40 dentist_form_submit" style="width: 150px;">SAVE </a>
                                    <!-- <a href="#" class="btn btn-xs btn-info" style="width: 150px;">Remove from front</a> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 margin-bottom-40">
                            <div class="col-md-12 shadow-boxx">
                                    ...
                                    <table class="form-info margin-bottom-10" style="width: 100%;">
                                         <tbody class="pedriatric_form_body">
                                            ...
                                            @endif    
                                                <td>
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="pedriatric_form" value="{{$form->id}}"  @if($count == 'exist') checked  @endif />
                                                        <i></i> {{$form->name}} 
                                                    </label>
                                                </td>   
                                            @if($i == 4) 
                                ...
                                <hr />
                                <div class="col-md-12 text-center padding-0">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-info margin-right-40 pedriatric_form_submit" style="width: 150px;">SAVE </a>
                                   <!--  <a href="#" class="btn btn-xs btn-info" style="width: 150px;">Remove from front</a> -->
                                </div>
                            </div>
                        </div>
   ...
   $(".general_form_submit").on("click", function(){
        ...
        if(sub_arr != ""){
            $.ajax({
                ...
                data: {'form_cat_id':1,'sub_arr':JSON.stringify(sub_arr),'_token': '<?= csrf_token() ?>' },
                type: 'POST',
    ...
    $(".medical_form_submit").on("click", function(){
        ...
        if(sub_arr != ""){
            $.ajax({
                url: "add_affiliate_library_form",
                data: {'form_cat_id':3,'sub_arr':JSON.stringify(sub_arr),'_token': '<?= csrf_token() ?>' },
                type: 'POST',
                success: function(result) {
                    console.log(result);
                    location.reload();
    ...
    $(".dentist_form_submit").on("click", function(){
        ...
        if(sub_arr != ""){
            $.ajax({
                url: "add_affiliate_library_form",
                data: {'form_cat_id':2,'sub_arr':JSON.stringify(sub_arr),'_token': '<?= csrf_token() ?>' },
                type: 'POST',
                success: function(result) {
                    console.log(result);
                    location.reload();
    ...
    $(".pedriatric_form_submit").on("click", function(){
        ...
        if(sub_arr != ""){
            $.ajax({
                url: "add_affiliate_library_form",
                data: {'form_cat_id':4,'sub_arr':JSON.stringify(sub_arr),'_token': '<?= csrf_token() ?>' },
                type: 'POST',
                success: function(result) {
                    console.log(result);
                    location.reload();
