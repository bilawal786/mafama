...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <!-- REVOLUTION SLIDER -->
        <link href="<?php echo e(asset('public/assets/plugins/slider.revolution/css/extralayers.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('public/assets/plugins/slider.revolution/css/settings.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- THEME CSS -->
        <link href="<?php echo e(asset('public/assets/css/essentials.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('public/assets/css/layout.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- PAGE LEVEL SCRIPTS -->
        <link href="<?php echo e(asset('public/assets/css/header-1.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('public/assets/css/color_scheme/green.css')); ?>" rel="stylesheet" type="text/css" id="color_scheme" />
        <link href="<?php echo e(asset('public/assets/css/layout-datatables.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('public/custom.css')); ?>" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(asset('public/fullcalendar/fullcalendar.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/fullcalendar/fullcalendar.print.css')); ?>" media="print">
            ...
            <div id="topBar">
                <div class="container">
                    <div class="row">
                        ...
                        <li>
                            <a class="dropdown-toggle no-text-underline" data-toggle="dropdown" href="#"><img class="flag-lang" src="<?php echo e(asset('public/assets/images/flags/us.png')); ?>" width="16" height="11" alt="lang" /> ENGLISH</a>
                            <ul class="dropdown-langs dropdown-menu">
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('public/assets/images/flags/us.png')); ?>" width="16" height="11" alt="lang" /> ENGLISH</a></li>
                                <li class="divider"></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('public/assets/images/flags/de.png')); ?>" width="16" height="11" alt="lang" /> GERMAN</a></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('public/assets/images/flags/ru.png')); ?>" width="16" height="11" alt="lang" /> RUSSIAN</a></li>
                                <li><a tabindex="-1" href="#"><img class="flag-lang" src="<?php echo e(asset('public/assets/images/flags/it.png')); ?>" width="16" height="11" alt="lang" /> ITALIAN</a></li>
                            </ul>
                        </li>
                    </ul>-->
                            <ul class="top-links list-inline">
                                <li>
                                    <a class="logo" href="<?php echo e(url('/')); ?>">
                                        <img src="<?php echo e(asset('public/images/logo1.jpg')); ?>" alt="" />
                                    </a>
                                </li>
                                <li>
                                     <?php if(auth()->guard()->guest()): ?>
                                   <?php if($status[0]->affiliatedisplay == "on"): ?>                                       
                                        <a href="<?php echo e(url('affiliate_registration')); ?>" class="btn btn-lg btn-info" style="margin-left:10px;width: 100%; line-height: 18px; font-size: 15px;">Affiliate Registration</a>
                                    <?php else: ?>
                        ...
                        <div class="col-md-4 col-xs-12 padding-0 text-center top-bar-sidediv">
                            ...
                            <?php else: ?> 
                             <a   data-clipboard-text="<?php echo e($mysharing_link); ?>" href="javascript:void(0)" class="btn btn-lg btn-info clipboard" style="width: 80%; line-height: 18px; font-size: 15px;">SHARE LINK</a>
                            <?php endif; ?>
...
endif; ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="Email Address" autofocus>
                            ...
                            <?php else: ?>  
                                <div class="nav-item dropdown text-right userdrop">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle btn btn-info user-log-button" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                        <?php echo e(Auth::user()->name); ?> <span class="caret" style="margin-left: 10px; color: white;"></span>
                                    </a>
...
//echo Route::currentRouteName();
                ...
                <div class="row margin-top-10 margin-bottom-10">
                    ...
                    <div class="col-md-6 padding-0">
                        ...
                        <div class="col-md-6" style="margin-top: 10px; text-align: center; padding-right: 5px; padding-left: 10px;">
                            <a href="<?php echo e(url('business_registration')); ?>" class="btn btn-lg btn-info" style="width: 100%;">Register a Business</a>
                        </div>
                        <div class="col-md-6" style="margin-top: 10px; text-align: center; padding-left: 5px; padding-right: 10px;">
                            <form action="<?php echo e(url('search_a_business')); ?>" role="form" method="post" style="margin-bottom: 0px;">
                                <?php echo csrf_field(); ?>
                                ...
                                <nav class="nav-main" style="text-align: center;">
                                    <ul id="topMain" class="nav nav-pills nav-main text-center" style="display: inline-block;">
                                        <?php if((Auth::id() != "") && (Auth::user()->role == "affiliate")){ ?>
                                            <li><a href="<?php echo e(url('/')); ?>"><i class="fas fa-home" style="font-style: normal"></i></a></li>
                                            <li><a href="<?php echo e(url('notifications')); ?>"><div class="noti_sec"><i class="fas fa-bell"></i><span class="noti_count"><?php echo e(notification_count()); ?></span></div></a></li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('profile')); ?>"><i class="fa fa-caret-square-o-right"></i> Profile </a>
                                                                            <?php 
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('banner')); ?>"><i class="fa fa-caret-square-o-right"></i> Banner</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                       <!--  <li>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('user_access_rights')); ?>"><i class="fa fa-caret-square-o-right"></i> User Access Roles</a>
                                                                            <?php 
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                         <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('survey_polls')); ?>"><i class="fa fa-caret-square-o-right"></i> Survey/Polls</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li> 
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('add_appointment_setting')); ?>"><i class="fa fa-caret-square-o-right"></i> Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('client_mgmt_setting')); ?>"><i class="fa fa-caret-square-o-right"></i> Client Management</a>
                                                                            <?php 
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('email_mgmt_setting')); ?>"><i class="fa fa-caret-square-o-right"></i> Email Management</a>
                                                                            <?php 
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('financial_mgmt_setting')); ?>"><i class="fa fa-caret-square-o-right"></i> Financial Management</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('forms_library')); ?>"><i class="fa fa-caret-square-o-right"></i> Upload Form Library</a>
                                                                            <?php 
                                                                                }
                                                                            ?> 
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('setting_tutorials')); ?>"><i class="fa fa-caret-square-o-right"></i> Tutorial</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        ...
                                                                        <li>
                                                                            <a href="<?php echo e(url('renew-plan')); ?>"><i class="fa fa-caret-square-o-right"></i> Renew Plan</a>
                                                                        </li>
                                                                         <?php endif; ?>
                                                                         <?php endif; ?>
                                                                        <?php endif; ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('appointment_step1')); ?>"><i class="fa fa-caret-square-o-right"></i> Make Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('change_appointment')); ?>"><i class="fa fa-caret-square-o-right"></i> Change Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('cancel_appointment')); ?>"><i class="fa fa-caret-square-o-right"></i> Cancel Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('comparison_appointment')); ?>"><i class="fa fa-caret-square-o-right"></i> Appointment Comparison</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('manage_appointment')); ?>"><i class="fa fa-caret-square-o-right"></i> Manage Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('appointment_tutorials')); ?>"><i class="fa fa-caret-square-o-right"></i> Tutorial</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                        ...
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('manage_clients')); ?>"><i class="fa fa-caret-square-o-right"></i> Manage Client Profile</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('schedule_birthday')); ?>"><i class="fa fa-caret-square-o-right"></i> Scheduler</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                    ...
                                                                    <ul class="list-unstyled">
                                                                       <!--  <li>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('profile_info')); ?>"><i class="fa fa-caret-square-o-right"></i> Client Access</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                             ...
                                                             <li>
                                                                    ...
                                                                    ?>
                                                                            <a href="<?php echo e(url('client-survey-records')); ?>"><i class="fa fa-caret-square-o-right"></i> Client Survey Results</a>
                                                                    <?php
                                                                        }
                                                                    ?>
                                                                </li>
                                                             ...
                                                             <?php endif; ?>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('client_tutorials')); ?>"><i class="fa fa-caret-square-o-right"></i> Tutorial</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <ul class="list-unstyled">
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('email_campaign')); ?>"><i class="fa fa-caret-square-o-right"></i> Email Campaign</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('send_email')); ?>"><i class="fa fa-caret-square-o-right"></i> Send Emails</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('send_cards')); ?>"><i class="fa fa-caret-square-o-right"></i> Send Cards</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('send_video')); ?>"><i class="fa fa-caret-square-o-right"></i> Send Videos</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <ul class="list-unstyled">
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('send_sms')); ?>"><i class="fa fa-caret-square-o-right"></i> Send SMS</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('comparison_email')); ?>"><i class="fa fa-caret-square-o-right"></i> Comparison</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('manage_folders')); ?>"><i class="fa fa-caret-square-o-right"></i> Manage</a>
                                                                                <?php
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                ?>
                                                                                        <a href="<?php echo e(url('email_tutorials')); ?>"><i class="fa fa-caret-square-o-right"></i> Tutorial</a>
                                                                                <?php 
                                                                                    }
                                                                                ?>
                                                                            </li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('revenue_records')); ?>"><i class="fa fa-caret-square-o-right"></i> Record Transactions</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('create_budget')); ?>"><i class="fa fa-caret-square-o-right"></i> Budget</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('create_projection')); ?>"><i class="fa fa-caret-square-o-right"></i> Projection</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                         <li>
                                                <a href="<?php echo e(url('calculator')); ?>"><i class="fa fa-caret-square-o-right"></i> Calculator</a>
                                            </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('profit_loss_stmt')); ?>"><i class="fa fa-caret-square-o-right"></i> Reports</a>
                                                                            <?php   
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('comparison_finance')); ?>"><i class="fa fa-caret-square-o-right"></i> Financial Comparison</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('financial_tutorials')); ?>"><i class="fa fa-caret-square-o-right"></i> Tutorial</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                ...
                                <nav class="nav-main">
                                    <ul id="topMain" class="nav nav-pills nav-main text-center">
                                        ...
                                        <li>
                                            ...
                                            ?>
                                                    <a href="<?php echo e(url('appointment_step1')); ?>">Make Appointment</a>
                                            <?php
                                                }
                                            ?>
                                        </li>
 ...
 <nav class="nav-main">
    <ul id="topMain" class="nav nav-pills nav-main text-center">
        <?php if((Auth::id() != "") && (Auth::user()->role == "affiliate")){ ?>
            <li><a href="<?php echo e(url('/')); ?>"><i class="fas fa-home" style="font-style: normal"></i></a></li>
            <li><a href="<?php echo e(url('notifications')); ?>"><div class="noti_sec"><i class="fas fa-bell"></i><span class="noti_count"><?php echo e($count = App\Http\Controllers\MainController::notification_count()); ?></span></div></a></li>
            <li><a href="<?php echo e(url('front_dashboard')); ?>">Dashboard</a></li>
        <?php }else{ ?>
            <li><a href="<?php echo e(url('/')); ?>">Home</a></li>
        <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled">
                                ...
                                <?php endif; ?>
                                 <?php if(isLinkAccess($links[1]->id) == 1): ?>
                                <li>
                                    <?php
                            ...
                            <ul class="list-unstyled">
                             ...
                             <li>
                                    ...
                                    <?php
                                        if($links[4]->status == "on"){
                                    ?>
                                            <a href="<?php echo e(url('client-report-view')); ?>"><i class="fa fa-caret-square-o-right"></i> Client Report View</a>
                                    <?php
                                        }
                                    ?>
                                </li>
            ...
            <ul class="dropdown-menu archives-li" style="left: 65%;">
                <li>
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled">
                               <li> <a href="<?php echo e(url('front_archives')); ?>"> <i class="fa fa-caret-square-o-right"></i>Archives</a></li>
                               <?php
                                 $enable=2;
                               ?>
            ...
            <div class="modal-body ">
                <div class="row gy-4" style="margin-top: 10px;">
                    <div class="col-md-12">
                      ...
                      <hr>
                    <form action="<?php echo e(url('add_enquiry_entry')); ?>" method="POST" id="" enctype="multipart/form-data">   
                    <?php echo csrf_field(); ?>
                            <div class="col-md-12" style="margin-top: 30px;">
                                 <div class="form-group">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control"  placeholder="Name" name="name" required="" autocomplete="off" value="<?php echo e(old('name')); ?>">
                             ...
                             <span class="text-danger"><?php echo e($errors->first('name')); ?></span>
                               ...
                               <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  placeholder="Email" name="email_id" required="" autocomplete="off" value="<?php echo e(old('email_id')); ?>" >
                             ...
                             <span class="text-danger"><?php echo e($errors->first('email_id')); ?></span>
                               ...
                               <?php endif; ?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"  placeholder="Contact No." name="contact_no" required="" autocomplete="off" value="<?php echo e(old('contact_no')); ?>" >
                                    <?php if($errors->has('contact_no')): ?>
                             <span class="text-danger"><?php echo e($errors->first('contact_no')); ?></span>
...
<script  src="<?php echo e(asset('public/assets/plugins/jquery/jquery-2.1.4.min.js')); ?>"></script>
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
<!-- <script src="https://netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script> -->
        <script type="text/javascript" src="<?php echo e(asset('public/assets/js/scripts.js')); ?>"></script>
        <!-- REVOLUTION SLIDER -->
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/slider.revolution/js/jquery.themepunch.tools.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/slider.revolution/js/jquery.themepunch.revolution.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/js/view/demo.revolution_slider.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/datatables/js/jquery.dataTables.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/datatables/js/dataTables.tableTools.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/datatables/js/dataTables.colReorder.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/datatables/js/dataTables.scroller.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/datatables/dataTables.bootstrap.js')); ?>"></script>
        <script src="<?php echo e(asset('public/fullcalendar/fullcalendar.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/assets/plugins/select2/js/select2.full.min.js')); ?>"></script>
        ...
        <?php if(Auth::check() && Auth::user()->role=='affiliate'): ?>
          <!--  <script type="text/javascript" src="<?php echo e(asset('public/includes/eventHandling.js')); ?>"></script> -->
        <?php endif; ?>
 <!-- <script type="text/javascript" src="<?php echo e(asset('public/includes/eventHandling.js')); ?>"></script> -->
...
<?php /**PATH /home/wwwmafama/public_html/resources/views/layouts/main.blade.php ENDPATH**/ ?>