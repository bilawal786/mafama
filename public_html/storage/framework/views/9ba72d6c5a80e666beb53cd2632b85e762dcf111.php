					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<form action="<?php echo e(url('update_affiliate_template')); ?>" method="POST" id="" enctype="multipart/form-data">	
									<?php echo csrf_field(); ?>
									...
									<div class="row gy-4" style="padding-bottom:20px;">
                                      ...
                                      <div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="comm_subject"  value="<?php echo e(isset($template->id)?$template->comm_subject:''); ?>"  required>
								       ...
								       <div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="comm_message" class="editor1" rows="10"><?php echo e(isset($template->id)?$template->comm_message:''); ?></textarea>
											</div>
										</div>	
                                      <div class="col-md-12">
									 	<div class="form-group">
									 ...
									 <div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="bonus_subject_day"  value="<?php echo e(isset($template->id)?$template->bonus_subject_day:''); ?>"  required>
								       ...
								       <div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="bonus_message_day" class="editor1" rows="10"><?php echo e(isset($template->id)?$template->bonus_message_day:''); ?></textarea>
											</div>
										</div>	
									    ...
									    <div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="bonus_subject_quarter"  value="<?php echo e(isset($template->id)?$template->bonus_subject_quarter:''); ?>"  required>
								       ...
								       <div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="bonus_message_quarter" class="editor1" rows="10"><?php echo e(isset($template->id)?$template->bonus_message_quarter:''); ?></textarea>
											</div>
										</div>	
									    ...
									    <div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="prize_subject_day"  value="<?php echo e(isset($template->id)?$template->prize_subject_day:''); ?>"  required>
								       ...
								       <div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="prize_message_day" class="editor1" rows="10"><?php echo e(isset($template->id)?$template->prize_message_day:''); ?></textarea>
											</div>
										</div>	
									    ...
									    <div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control"  name="prize_subject_quarter"  value="<?php echo e(isset($template->id)?$template->prize_subject_quarter:''); ?>"  required>
								       ...
								       <div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="prize_message_quarter" class="editor1" rows="10"><?php echo e(isset($template->id)?$template->prize_message_quarter:''); ?></textarea>
											</div>
										</div>	
									 <div class="col-md-12">
									 	<div class="form-group">
									...
									<?php if(permission_access('aff_email_edit')==1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wwwmafama/public_html/resources/views/admin/template/affiliate_email_templates.blade.php ENDPATH**/ ?>