									...
									<div class="row gy-4" style="padding-bottom:20px;">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control"  placeholder="Registration success page message" name="success_page_message" rows="1">{{ isset($setting->id)?$setting->success_page_message:''}}</textarea> 
