                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 margin-bottom-20 margin-top-40">
                                    <div class="col-md-6">
                                        <div class="col-md-12 shadow-boxx">
                                            ...
                                            <form action="{{ url('appointment_step2') }}" method="POST" enctype="multipart/form-data"> 
                                                @csrf   
                                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12 shadow-boxx">
                                            ...
                                            <form action="{{ url('appointment_stepp2') }}" method="POST" enctype="multipart/form-data"> 
                                                @csrf
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    ?>
                                    <form action="{{ url('appointment_steppp2') }}" method="POST" id="" enctype="multipart/form-data">
                                    @csrf
