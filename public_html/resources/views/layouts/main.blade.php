                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="{{ url('appointment_step1') }}"><i class="fa fa-caret-square-o-right"></i> Make Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="{{ url('manage_appointment') }}"><i class="fa fa-caret-square-o-right"></i> Manage Appointment</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                ...
                                <nav class="nav-main">
                                    <ul id="topMain" class="nav nav-pills nav-main text-center">
                                        ...
                                        <li>
                                            ...
                                            ?>
                                                    <a href="{{ url('appointment_step1') }}">Make Appointment</a>
                                            <?php
                                                }
                                            ?>
                                        </li>
