    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
             ...
             <div class="col-md-12 text-right margin-bottom-20" style="padding:0;">
                    ...
                    <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                        <form action="{{ url('manage_folders_entry') }}" method="POST" id="" enctype="multipart/form-data">
                        @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if(($value->folder_name == "Family") || ($value->folder_name == "Friends") || ($value->folder_name == "Client") || ($value->folder_name == "VIP client") || ($value->folder_name == "Basket 1") || ($value->folder_name == "Basket 2") || ($value->folder_name) == "Basket X"){ ?>
                                            <td>
                                                <form action="{{ url('view_manage_folders') }}" method="POST" id="" enctype="multipart/form-data" style="display: inline-flex;">
                                                @csrf
                                        ...
                                        <?php }else{ ?>
                                            <td>
                                                <form action="{{ url('edit_manage_folders') }}" method="POST" id="" enctype="multipart/form-data" style="display: inline-flex;">
                                                @csrf
                                                    <input type="hidden" name="id" value="<?= $value->id ?>">
                                                    <input type="submit" class="btn btn-xs btn-info" value="Edit">
                                                </form>
                                                <form action="{{ url('delete_manage_folders') }}" method="POST" id="" enctype="multipart/form-data" style="display: inline-flex;">
                                                @csrf
                                                    <input type="hidden" name="id" value="<?= $value->id ?>">
