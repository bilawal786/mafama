                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <a href="{{ url('change_appointment_step') }}/<?= $value->aid ?>" class="btn btn-xs btn-success">Change</a>
                                                    <a href="{{ url('change_appointment_view') }}/<?= $value->aid ?>" class="btn btn-xs btn-danger">View</a>
                                                <?php }else{ ?>
