                        ...
                        <script type="text/javascript">
                              $(function () {
                                    ...
                                    var bar = new Morris.Bar({
                                      ...
                                      resize: true,
                                      data: [
                                        {y: 'Jan-Mar', a: <?= $value->janmar ?>, b: <?php echo $actual_janmar = App\Http\Controllers\HomeController::getjanmaractualexp($value->name); ?>},
                                        {y: 'Apr-Jun', a: <?= $value->aprjun ?>, b: <?php echo $actual_aprjun = App\Http\Controllers\HomeController::getaprjunactualexp($value->name); ?>},
                                        {y: 'Jul-Sep', a: <?= $value->julsep ?>, b: <?php echo $actual_julsep = App\Http\Controllers\HomeController::getjulsepactualexp($value->name); ?>},
                                        {y: 'Oct-Dec', a: <?= $value->octdec ?>, b: <?php echo $actual_octdec = App\Http\Controllers\HomeController::getoctdecactualexp($value->name); ?>}
                                      ],
