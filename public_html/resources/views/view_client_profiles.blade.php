                                ...
                                <div class="col-md-3 margin-bottom-20 reslt">
                                    <div class="col-md-12 shadow-boxx">
                                        <div class="col-md-12 padding-0 text-center">
                                            <img src="{{ asset('public/assets/images/client') }}/<?= $value->image ?>" style="border: 1px solid #da291c73 !important; border-radius: 5px;" width="130" height="130" alt="featured item" />
                                        </div>
