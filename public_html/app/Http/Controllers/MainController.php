...
public function monthlylistfinance(Request $request)
    {
        ...
        <tbody>
            ...
            <tr class="total-tr">
                ...
                <td><a class="revenue_by_month" data-month="01">'.$jantotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="02">'.$febtotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="03">'.$martotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="04">'.$aprtotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="05">'.$maytotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="06">'.$juntotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="07">'.$jultotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="08">'.$augtotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="09">'.$septotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="10">'.$octtotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="11">'.$novtotalactual.'</a></td>
                <td><a class="revenue_by_month" data-month="12">'.$dectotalactual.'</a></td>
                <td><a class="total_yearly_revenue" >'.$monthtotalactual.'</a></td>
            </tr>
            <tr>
            ...
            foreach($expense as $value){
                    ...
                    <tr class="odd gradeX">
                        ...
                        if($actual_jan!= 0){ echo '
                            <td><a class="actual_monthly_expense" id="01actualexpense'.$value->account_description.'">'.$actual_jan.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_jan.'</td>
                        '; }
                        ...
                        if($actual_feb != 0){ echo '
                            <td><a class="actual_monthly_expense" id="02actualexpense'.$value->account_description.'">'.$actual_feb.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_feb.'</td>
                        '; }
                        ...
                        if($actual_mar != 0){ echo '
                            <td><a class="actual_monthly_expense" id="03actualexpense'.$value->account_description.'">'.$actual_mar.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_mar.'</td>
                        '; }
                        ...
                        if($actual_apr != 0){ echo '
                            <td><a class="actual_monthly_expense" id="04actualexpense'.$value->account_description.'">'.$actual_apr.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_apr.'</td>
                        '; }
                        ...
                        if($actual_may != 0){ echo '
                            <td><a class="actual_monthly_expense" id="05actualexpense'.$value->account_description.'">'.$actual_may.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_may.'</td>
                        '; }
                        ...
                        if($actual_jun != 0){ echo '
                            <td><a class="actual_monthly_expense" id="06actualexpense'.$value->account_description.'">'.$actual_jun.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_jun.'</td>
                        '; }
                        ...
                        if($actual_jul != 0){ echo '
                            <td><a class="actual_monthly_expense" id="07actualexpense'.$value->account_description.'">'.$actual_jul.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_jul.'</td>
                        '; }
                        ...
                        if($actual_aug != 0){ echo '
                            <td><a class="actual_monthly_expense" id="08actualexpense'.$value->account_description.'">'.$actual_aug.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_aug.'</td>
                        '; }
                        ...
                        if($actual_sep != 0){ echo '
                            <td><a class="actual_monthly_expense" id="09actualexpense'.$value->account_description.'">'.$actual_sep.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_sep.'</td>
                        '; }
                        ...
                        if($actual_oct != 0){ echo '
                            <td><a class="actual_monthly_expense" id="10actualexpense'.$value->account_description.'">'.$actual_oct.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_oct.'</td>
                        '; }
                        ...
                        if($actual_nov != 0){ echo '
                            <td><a class="actual_monthly_expense" id="11actualexpense'.$value->account_description.'">'.$actual_nov.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_nov.'</td>
                        '; }
                        ...
                        if($actual_decem != 0){ echo '
                            <td><a class="actual_monthly_expense" id="12actualexpense'.$value->account_description.'">'.$actual_decem.'</a></td>
                        '; }else{ echo '
                            <td>'.$actual_decem.'</td>
                        '; }
            ...
            <tr class="total2-tr">
                ...
                <td><a class="total_expense_by_month" data-month="01">'.$jantotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="02">'.$febtotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="03">'.$martotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="04">'.$aprtotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="05">'.$maytotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="06">'.$juntotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="07">'.$jultotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="08">'.$augtotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="09">'.$septotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="10">'.$octtotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="11">'.$novtotal2actual.'</a></td>
                <td><a class="total_expense_by_month" data-month="12">'.$dectotal2actual.'</a></td>
                 
                <td><a class="total_yearly_expenses" >'.($jantotal2actual + $febtotal2actual + $martotal2actual + $aprtotal2actual + $maytotal2actual + $juntotal2actual + $jultotal2actual + $augtotal2actual + $septotal2actual + $octtotal2actual + $novtotal2actual + $dectotal2actual).'</a></td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
                <td class="fixed-side" style="text-align: left;"><b>Estimated Profit & Loss</b></td>
                <td><a class="revenue_expense_by_month" data-month="01">'.($jantotalactual-$jantotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="02">'.($febtotalactual-$febtotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="03">'.($martotalactual-$martotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="04">'.($aprtotalactual-$aprtotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="05">'.($maytotalactual-$maytotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="06">'.($juntotalactual-$juntotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="07">'.($jultotalactual-$jultotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="08">'.($augtotalactual-$augtotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="09">'.($septotalactual-$septotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="10">'.($octtotalactual-$octtotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="11">'.($novtotalactual-$novtotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="12">'.($dectotalactual-$dectotal2actual).'</a></td>
                <td><a class="revenue_expense_by_month" data-month="all">'.($monthtotalactual-($jantotal2actual + $febtotal2actual + $martotal2actual + $aprtotal2actual + $maytotal2actual + $juntotal2actual + $jultotal2actual + $augtotal2actual + $septotal2actual + $octtotal2actual + $novtotal2actual + $dectotal2actual)).'</a></td>
            </tr>
        </tfoot>';
    }
       ...
       // echo " $aprtotalactual + $maytotalactual + $juntotalactual;";die;
        ...
        echo '<thead>
            ...
            <tbody>
                ...
                <tr class="total-tr">
                    <td class="fixed-side" style=""><b>Total Revenue</b></td>
                    <td><a class="quaterly_total_revenue" data-month="01">'.$janmartotalactual.'</a></td>
                    <td><a class="quaterly_total_revenue" data-month="04">'.$aprjuntotalactual.'</a></td>
                    <td><a class="quaterly_total_revenue" data-month="07">'.$julseptotalactual.'</a></td>
                    <td><a class="quaterly_total_revenue" data-month="10">'.$octdectotalactual.'</a></td>
                    <td><a class="total_yearly_revenue" href="javascript:void(0)">'.$monthtotalactual.'</a></td>
                </tr>
                <tr>
                    <td class="fixed-side" style="text-align: left; color: #da291c;"><b>Expenses</b></td>
                    <td></td>
                ...
                <tr class="total2-tr">
                    <td class="fixed-side" style=""><b>Total Expenses</b></td>
                    <td><a class="quaterly_total_expense" data-month="01">'.$janmartotal2actual.'</a></td>
                    <td><a class="quaterly_total_expense" data-month="04">'.$aprjuntotal2actual.'</a></td>
                    <td><a class="quaterly_total_expense" data-month="07">'.$julseptotal2actual.'</a></td>
                    <td><a class="quaterly_total_expense" data-month="10">'.$octdectotal2actual.'</a></td>
                    <td><a class="total_yearly_expenses" href="javascript:void(0)">'.($janmartotal2actual + $aprjuntotal2actual + $julseptotal2actual + $octdectotal2actual).'</a></td>
                    </td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td class="fixed-side" style="text-align: left;"><b>Estimated Profit & Loss</b></td>
                    <td><a class="qly_total_revenue_expense" data-month="01">'.($janmartotalactual-$janmartotal2actual).'</a></td>
                    <td><a class="qly_total_revenue_expense" data-month="04">'.($aprjuntotalactual-$aprjuntotal2actual).'</a></td>
                    <td><a class="qly_total_revenue_expense" data-month="07">'.($julseptotalactual-$julseptotal2actual).'</a></td>
                    <td><a class="qly_total_revenue_expense" data-month="10">'.($octdectotalactual-$octdectotal2actual).'</a></td>
                    <td><a class="qly_total_revenue_expense" data-month="all">'.($monthtotalactual-($janmartotal2actual + $aprjuntotal2actual + $julseptotal2actual + $octdectotal2actual)).'</a></td>
                </tr>
            </tfoot>';
 ...
 public function get_revenue_by_month_page(Request $request)
    {
       ...
       $revenue_records = DB::table('revenue_record')->where('account_description', '!=', "Sales Tax Collected")->where('account_description', '!=', "Shipping Collected")->where('uid', $uid)->whereYear('transaction_date',$year)->whereMonth('transaction_date', $month)->orderBy('transaction_date', 'desc')->get();
