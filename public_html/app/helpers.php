...
function get_business_category_desc(){
     ...
     <?php 
    foreach ($imgs as $img) { ?>
        <div class="col-md-12 hide-child  child-<?= $category ?>" style="margin-bottom: 10px;border: 1px solid #da291c; border-radius: 3px; padding: 5px 10px;">
