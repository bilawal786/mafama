        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <div class="nk-block-head-content" style="margin-bottom:20px;display:flex;">
                    ...
                    <a href="<?php echo e(url('admin/admin-list')); ?>" class="btn btn-sm btn-primary" style="float:right;">Back</a>
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="" class="form-control" placeholder="Name" name="name" value="<?php echo e($admin ? $admin->name:''); ?>" title="Name is required">
                                            </div>
                                        </div>
                                         <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Email    </label>
                                                <input type="text" required="" class="form-control" placeholder="Email" name="email" <?php echo e($admin ? 'readonly':''); ?> value="<?php echo e($admin ? $admin->email:''); ?>" title="Email is required">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Phone    </label>
                                                <input type="number" required="" class="form-control" placeholder="Phone" name="phone" value="<?php echo e($admin ? $admin->phone:''); ?>" title="phone is required">
                                            </div>
                                        </div>
                                          <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Password    </label>
                                                <input type="password"  <?php echo e($admin ? '':'required'); ?> class="form-control" placeholder="Password" name="password" value="" title="Password is required">
                                            </div>
                                        </div>
                                         <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label">Zip Code    </label>
                                                <input type="text" required="" class="form-control" placeholder="zip code" name="zip_code" value="<?php echo e($admin ? $admin->zip_code:''); ?>" title="zip_code is required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="" class="form-control" placeholder="City" name="city" value="<?php echo e($admin ? $admin->city:''); ?>" title="city is required">
                                            </div>
                                        </div>
                                     ...
                                     <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" placeholder="Address" name="address"  ><?php echo e($admin ? $admin->address:''); ?></textarea>
                                            </div>
                                        </div>   
                                    </div>
       ...
       $test_components_per = array("test_components_views");
                                ...
                                <?php } ?>                               
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <input type="hidden" name="id"  value="<?php echo e($admin ? $admin->id:''); ?>" >    
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin/access_role/add_new_admin.blade.php ENDPATH**/ ?>