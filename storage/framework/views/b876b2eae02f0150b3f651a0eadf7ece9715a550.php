        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12">
                    ...
                    <hr />
                    <form action="<?php echo e(url('appointment_step4_details')); ?>" method="POST" enctype="multipart/form-data">   
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12 margin-bottom-40 margin-top-20">
                            ...
                            <div class="col-md-12 text-center margin-top-20">
                                ...
                                <a href="<?php echo e(url()->previous()); ?>" class="btn btn-sm btn-info" style="margin-right: 10px; width: 200px; height: 34px">Back</a>
            ...
            for (let j = 0; j < 7; j++) {
                if (i === 0 && j < firstDay) {  
                   ...
                   break;
                    ...
                    $.ajax({
                          url: url,
                          data: 'date=' + currentdate + '&currentmonth=' + currentmonth + '&currentyear=' + currentyear + '&appn_id=' + appn_id + '&_token=<?php echo e(csrf_token()); ?>',
                          type: "POST",
            ...
            $(document).on('click', '.showEvent', function(){
                if($(this).hasClass("prev_day")){
                    ...
                    $.ajax({
                          ...
                          data: 'todaysDate=' + todaysDate + '&appn_id=' + appn_id + '&_token=<?php echo e(csrf_token()); ?>',
                          type: "POST",
                        success: function (response) {
                            // alert(response);
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/appointment_step3.blade.php ENDPATH**/ ?>