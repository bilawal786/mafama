		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="row">
					...
					<form  action="<?php echo e(url('edit_user_access')); ?>" method="POST" id="" enctype="multipart/form-data">	
					<?php echo csrf_field(); ?>
						...
						<div class="col-md-12"  style="border:1px solid #da291c !important; border-radius:10px;padding-top:30px;padding-bottom:20px;">
								...
								<div class="form-group">
									...
									<div id="uploaded_video">
										<video width="200" height="120" muted>
										  	<source src="<?php echo e(asset('public/images/client')); ?>/<?= $users->video ?>" type="video/mp4">
										</video>
									</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div id="uploaded_img">
										<img src="<?php echo e(asset('public/images/client')); ?>/<?= $users->file ?>" width="200" height="120">
									</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/edit_user_access_rights.blade.php ENDPATH**/ ?>