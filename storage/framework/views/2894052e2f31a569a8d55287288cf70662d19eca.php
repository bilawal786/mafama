                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 margin-bottom-20 margin-top-40">
                                    <div class="col-md-6">
                                        <div class="col-md-12 shadow-boxx">
                                            ...
                                            <form action="<?php echo e(url('appointment_step2')); ?>" method="POST" enctype="multipart/form-data"> 
                                                <?php echo csrf_field(); ?>   
                                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12 shadow-boxx">
                                            ...
                                            <form action="<?php echo e(url('appointment_stepp2')); ?>" method="POST" enctype="multipart/form-data"> 
                                                <?php echo csrf_field(); ?>
                                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    ?>
                                    <form action="<?php echo e(url('appointment_steppp2')); ?>" method="POST" id="" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <!-- <div class="col-md-3">
                                        <ul class="category-li" style="list-style: none;">
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category1</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category2</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category3</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category4</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category5</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category6</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category7</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category8</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category9</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category10</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category11</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category12</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category13</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category14</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(url('appointment_step2')); ?>"><i class="fa fa-check-square-o"></i> Category15</a>
                                            </li>
                                        </ul>
                                    </div> -->
                                    <!-- <div class="col-md-3">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/appointment_step1.blade.php ENDPATH**/ ?>