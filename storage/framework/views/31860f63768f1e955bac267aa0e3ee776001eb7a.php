                        ...
                        <form method="POST" id="record_revenue" role="form" enctype="multipart/form-data">
                            ...
                            <div class="row margin-bottom-20">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" name="discount" class="form-control" id="discount_field" value="<?php echo e($revenue_records->discount); ?>" readonly>
                                </div>
                                <div class="col-md-2">
                                ...
                                ?>
                                <div class="col-md-4" style="margin-bottom: 20px;<?php echo e($dnone); ?>">
                                    <!--<label>Tax</label>-->
                                    <div style="margin-top: 25px">
                                        <div class="col-md-4">
                                            <label class="checkbox chk-sm ">
                                                <input class="tran_check" type="checkbox" name="tax1" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->tax_rate:$revenue_records->tax); ?>" <?php if($invoice_setup->is_tax == 1){ ?>checked <?php }else{ ?> readonly <?php } ?> onchange="tax_calc()" />
                                                <i></i> Tax
                                            </label>
                                        </div>
                                        <div class="col-md-8">
                                ...
                                <div class="col-md-4" style="margin-bottom: 20px;<?php echo e($dnone1); ?>">
                                     <div style="margin-top: 25px">
                                         <div class="col-md-4">
                                        <label class="checkbox chk-sm">
                                          <input class="tran_check" type="checkbox" name="shipping1" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->shipping_rate:$revenue_records->shipping); ?>" <?php if($invoice_setup->shipping_cost == 1){ ?>checked <?php } else{ ?> readonly <?php } ?> onchange="tax_calc()" />
                                                    <i></i> Shipping
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/edit_revenue_record.blade.php ENDPATH**/ ?>