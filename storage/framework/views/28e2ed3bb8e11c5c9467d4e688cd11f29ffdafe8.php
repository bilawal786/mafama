                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 padding-0 text-center top-bar-sidediv">
                            ...
                            <?php else: ?>
                                ...
                                <div class="margin-top-10">
                                    <a class="btn btn-sm btn-success rounded" href="https://wa.me/?text=<?php echo e($mysharing_link); ?>" style="line-height: 10px;">
                                        <i class="fa fa-whatsapp fa-3x padding-0"></i>
                                    </a>
                                </div>
                            <?php endif; ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('manage_appointment')); ?>"><i class="fa fa-caret-square-o-right"></i> Manage My Appointments</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <ul class="list-unstyled">
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            ?>
                                                                                    <a href="<?php echo e(url('appointment_step1')); ?>"><i class="fa fa-caret-square-o-right"></i> Make Appointment on the Network</a>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </li>
