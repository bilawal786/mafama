        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-20">
                    ...
                    <li class="active"><a href="<?php echo e(url('revenue_report')); ?>">Revenue Report</a></li>
                    ...
                    <li><a href="<?php echo e(url('paymentbalance_report')); ?>">Payment / Balance</a></li>
                </ul>
    ...
    $(".revenue_month").click(function(){
        ...
        if($(this).html() != 0){
            ...
            $.ajax({
                  ...
                  data: 'month=' + month + '&description=' + description + '&_token=<?php echo e(csrf_token()); ?>',
                  type: "POST",
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/revenue_report.blade.php ENDPATH**/ ?>