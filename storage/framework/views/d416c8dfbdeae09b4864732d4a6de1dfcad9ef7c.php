        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <form action="<?php echo e(url('updateclient_appointment')); ?>" method="POST" id="" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-12" style="border: 1px solid #da291c !important; border-radius: 10px; padding-top: 30px; padding-bottom: 20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center">
                                    <div>
                                        <img src="<?php echo e(asset('public/assets/images/client')); ?>/<?= $client[0]->image ?>" style="width: 100px; height: 100px; margin: 0 auto; border: 2px solid #da291c" id="blah">
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker" placeholder="" data-format="mm/dd/yyyy" name="dob" value="<?= $client[0]->dob ?>" required />
                                </div>
                            </div>
                            <!-- <div class="col-md-4">
                                <div class="form-group">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/edit_clientf.blade.php ENDPATH**/ ?>