								   ...
								   <div class="row gy-4" style="padding-bottom:20px;">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<span class="lbl_text"><?php echo e(isset($user->id)?$user->country:''); ?>  </span>
											</div>
										</div>
										...
										<div class="col-md-4">
											...
											<span class="lbl_text"><?php echo e(isset($user->id)?showcommuneName($user->commune):''); ?>  </span>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
										...
										<div class="col-md-4">
											...
											<span class="lbl_text"><?php echo e(isset($user->id)?showarrondissementName($user->arrondissement):''); ?>  </span>
											</div>
										</div>
										<?php endif; ?>
										...
										<div class="col-md-4">
											...
											<span class="lbl_text"><?php echo e(isset($user->id)?$user->state:''); ?>  </span>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<span class="lbl_text">
													...
													<?php else: ?>
													<?php echo e($user->business_category); ?>
										...
										<div class="col-md-4">
											<div class="form-group">
		                                        ...
		                                        <img src="<?php echo e(asset('public/images/affiliates/'.$user->image)); ?>" class="img img-responsive" style="width: 40px">
											</div>
										</div>
		 ...
		 <?php
		  ...
		  $icon='';
		   ...
		   ?>
            <div class="col-md-<?php echo e($grid); ?> col-md-offset-<?php echo e($offset); ?>">
                ...
                <div class="pricingTable <?php echo e($class); ?>">
                    ...
                    <div class="pricingTable-signup">
                    	<form></form>
        	<form action="<?php echo e(url('business_redirect_paypal')); ?>" method="POST"  id="form-<?php echo e($plan->id); ?>" >
        	 <?php echo csrf_field(); ?> 	  
            ...
            <a href="javascript:void(0)" class="subscribe-plan" data-id="<?php echo e($plan->id); ?>" data-order="<?php echo e(isset($user->id)?$user->id:''); ?>" data-price="<?php echo e($plan->monthly_fee); ?>">Continue</a>
             </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/main/business_registration_preview.blade.php ENDPATH**/ ?>