        ...
        $('#calendar').fullCalendar({
          ...
          events: 
            ...
            select: function(start, end, jsEvent, view) {
      	        ...
      	        //   $.ajax({
      	        //             url: url2,
      	        //             data: 'title=' + newEvent.title + '&description=' + description + '&start=' + newEvent.start + '&end=' + newEvent.end + '&_token=<?php echo e(csrf_token()); ?>',
      	        //             type: "POST",
      	        //             success: function (data) {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/calender_meeting.blade.php ENDPATH**/ ?>