                ...
                <div class="text-center">
                    <ul class="" id="monthlylist">
                        <?php foreach($years as $value){ ?>
                            <li <?php if($value == date('Y')){ ?> style="text-decoration: underline;" class="act" <?php } ?>><?php echo e($value); ?></li>
                        <?php } ?>
                    </ul>
    ...
    $("#monthlylist li").click(function(){
        ...
        $(document).on("click", "#editing .revenue_det", function(){
            ...
            $.ajax({
                  ...
                  data: 'year=' + year + '&month=' + month + '&account_description=' + account_description + '&_token=<?php echo e(csrf_token()); ?>',
                  type: "POST",
                success: function (response) {
                    // alert(response);
        ...
        $(document).on("click", "#editing .total_revenue_det", function(){
            ...
            $.ajax({
                  ...
                  data: 'year=' + year + '&account_description=' + account_description + '&_token=<?php echo e(csrf_token()); ?>',
                  type: "POST",
                success: function (response) {
                    // alert(response);
                    $("#monthly_details").html(response);
        ...
        $(document).on("click", "#editing .asset_det", function(){
            ...
            $.ajax({
                  ...
                  data: 'year=' + year + '&month=' + month + '&description=' + description + '&_token=<?php echo e(csrf_token()); ?>',
                  type: "POST",
                success: function (response) {
                    // alert(response);
                    $("#monthly_details").html(response);
...
<script>
    ...
    document.getElementById("exp_1").innerHTML = sumVal11.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_2").innerHTML = sumVal21.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_3").innerHTML = sumVal31.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_4").innerHTML = sumVal41.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_5").innerHTML = sumVal51.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_6").innerHTML = sumVal61.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_7").innerHTML = sumVal71.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_8").innerHTML = sumVal81.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_9").innerHTML = sumVal91.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_10").innerHTML = sumVal101.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_11").innerHTML = sumVal111.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_12").innerHTML = sumVal121.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    document.getElementById("exp_13").innerHTML = sumVal131.toLocaleString('en',{minimumFractionDigits: 0,maximumFractionDigits: 0});
    }
...
<script>
    ...
    for (var i = 0; i < table.rows.length; i++) {
        profit1 = profit1 + parseFloat((table.rows[i].cells[1].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[1].innerText).toString().replace(/,/g, ''));
    ...
    for (var i = 0; i < table.rows.length; i++) {
        profit2 = profit2 + parseFloat((table.rows[i].cells[2].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[2].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit3 = profit3 + parseFloat((table.rows[i].cells[3].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[3].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit4 = profit4 + parseFloat((table.rows[i].cells[4].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[4].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit5 = profit5 + parseFloat((table.rows[i].cells[5].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[5].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit6 = profit6 + parseFloat((table.rows[i].cells[6].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[6].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit7 = profit7 + parseFloat((table.rows[i].cells[7].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[7].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit8 = profit8 + parseFloat((table.rows[i].cells[8].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[8].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit9 = profit9 + parseFloat((table.rows[i].cells[9].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[9].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit10 = profit10 + parseFloat((table.rows[i].cells[10].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[10].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit11 = profit11 + parseFloat((table.rows[i].cells[11].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[11].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit12 = profit12 + parseFloat((table.rows[i].cells[12].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[12].innerText).toString().replace(/,/g, ''));
    }

    for (var i = 0; i < table.rows.length; i++) {
        profit13 = profit13 + parseFloat((table.rows[i].cells[13].innerText).toString().replace(/,/g, '')) - parseFloat((table2.rows[i].cells[13].innerText).toString().replace(/,/g, ''));
    }
