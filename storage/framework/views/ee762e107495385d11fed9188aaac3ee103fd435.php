...
//         $.ajax({
//                 url: url1,
//                 data: {val: value123, acc: val, _token: "<?php echo e(csrf_token()); ?>"},
//                 type: "POST",
...
$(".sch").click(function(){
    ...
    if(confirm('Are you sure to apply the Changes?')){
        ...
        $.ajax({
                url: url1,
                data: {val: value123, _token: "<?php echo e(csrf_token()); ?>"},
                type: "POST",
                success: function (response) {
                    if (response == 123) {
                        notify("Something went wrong", "error");
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/main/projection_setup.blade.php ENDPATH**/ ?>