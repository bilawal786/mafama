	...
	<div class="container-fluid">
		<div class="nk-content-inner">
			<div class="nk-content-body">
              ...
              <form id="" action="<?php echo e(url('intro_video_update')); ?>" method="POST" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
										...
										<div class="col-md-12">
										 ...
										 <div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="page_content" class="editor1" id="summernote" rows="10"><?php echo e($video->page_content); ?></textarea>
											</div>
										</div>
...
<!--config.extraPlugins = "<?php echo e(asset('public/admin_assets/colorbutton')); ?>";-->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin/introduction_video_upload.blade.php ENDPATH**/ ?>