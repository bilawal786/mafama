            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-30">
                        <li class="active"><a href="<?php echo e(url('financial_mgmt_setting')); ?>">Create Revenue Account</a></li>
                        ...
                        <li><a href="<?php echo e(url('financial_mgmt_choose_template')); ?>">Activate Financial Accounts</a></li>
                    </ul>

                    <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-40">
                        <li><a href="<?php echo e(url('create_budget')); ?>">Budget Set-up</a></li>
                        <li><a href="<?php echo e(url('projection_setup')); ?>">Projection Set-up</a></li>
                    </ul>
...
<script type="text/javascript">
    ...
    $("#delete_revenuee").on('click', function(e){
        ...
        $.ajax({
              url: url,
              data: 'id=' + id + '&delete_reason=' + delete_reason + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/financial_mgmt_setting.blade.php ENDPATH**/ ?>