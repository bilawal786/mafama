                ...
                <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs nav-button-tabs nav-justified">
                            <li ><a href="<?php echo e(url('paymentbalance_report')); ?>" >Monthly</a></li>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th id="qty_record" data-id="01" <?php if($cmonth >=1 && $cmonth < 4): ?> class="active1"  <?php endif; ?>>Jan-Mar</th>
                                            <th id="qty_record" data-id="04"  <?php if($cmonth >=4 && $cmonth < 7): ?> class="active1"  <?php endif; ?>>Apr-Jun</th>
                                            <th id="qty_record" data-id="07"  <?php if($cmonth >=7 && $cmonth < 10): ?> class="active1"  <?php endif; ?>>Jul-Sep</th>
                                            <th id="qty_record" data-id="10"  <?php if($cmonth >=10 && $cmonth <= 12): ?> class="active1"  <?php endif; ?>>Oct-Dec</th>
                    ...
                    <input type="checkbox" class="group-checkable" data-set="#datatable_sample checkboxes" />
                                    ...
                                    // dd($client);
                                        ...
                                        <tr class="" style="background: #800080">
                                            ...
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp); ?></td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp_d); ?></td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp2); ?></td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp3); ?></td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp4); ?></td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp5); ?></td>
                                            <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($temp6); ?></td>
                                        </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/paymentbalance_quaterly_report.blade.php ENDPATH**/ ?>