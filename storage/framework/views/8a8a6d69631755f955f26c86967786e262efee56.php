            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12 text-right margin-bottom-20">
                  <span style="display:inline-block;max-width: 344px;width: 100%;">
                	...
                	<input  onclick="copy1()" class="copy-input" value="<?php echo e($my_profile_link); ?>"  id="copyClipboard1" style="margin-right:20px;" readonly>
                </span>
                    ...
                    <input  onclick="copy()" class="copy-input" value="<?php echo e($my_referral_link); ?>"  id="copyClipboard" style="margin-right:20px;" readonly>
                     </span>
                    ...
                    <form action="" method="POST" id="register" role="form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                     <p class="margin-bottom-0" style="font-size: 15px; color: #da291c;">Folders    <a href="<?php echo e(url('manage_contacts')); ?>"  class="chk-sm" style="color: #fff;margin-left:20px;font-weight:900;font-size:14px!important;background:#10c310e0;padding:4px">Manage/Add Contact</a></p>
                                 </div>
                                          ...
                                          <div id="owl-demo" class="owl-carousel owl-theme">
                                            <?php 
                                               ...
                                               <div class=" col-md-12 text-center item " >
                                                        <a onclick="titleClick(this.id)" class="btn btn-xs btn-black btn-title"  id="<?php echo e($value->subject); ?>"><?php echo e($value->subject); ?></a>
                                                    </div>
                                            <?php
                                                $cnt++;
                                                if($cnt == 5){
                                ...
                                <li class="<?php if($c == 0){echo 'active';} ?>"><a href="#card_<?= $value->category ?>" data-toggle="tab"><?= $value->category ?></a></li>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-10 padding-0">
                                            <ul style="list-style-type: none; padding: 0; margin: 0"><?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li class="color-td" style="background-color: <?php echo e($color->color); ?>; display: inline-block;"></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/send_cards.blade.php ENDPATH**/ ?>