      ...
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12">
            ...
            <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-20">
               <li class="active"><a href="<?php echo e(url('profit_loss_stmt')); ?>">Profit / Loss Statement</a></li>
               <li><a href="<?php echo e(url('revenue_report')); ?>">Revenue Report</a></li>
               <li><a href="<?php echo e(url('expenses_report')); ?>">Expense Report</a></li>
               <li><a href="<?php echo e(url('balancesheet_report')); ?>">Balance Sheet</a></li>
               <li><a href="<?php echo e(url('paymentbalance_report')); ?>">Clients With Balance</a></li>
            </ul>
                        ...
                        <div class="">
                           <div class="row"  style="margin: 10px 0;">
                              ...
                              <div class="col-md-9">
                                 ...
                                 <a href="javascript:void(0)" data-id="<?php echo $value; ?>" id="weeklyyearlist"><span class="act"  style="margin-right: 12px;background-color: #da291c;
                                    border-color: #da291c; color: #fff; padding: 1%; border-radius: 5%"><?php echo e($value); ?></span></a>
                                 <?php } ?>
                              </div>
                           </div>
                                 ...
                                 <table class="table table-striped table-bordered table-hover main-table" id="">
                                    ...
                                    <tbody>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td><?php echo e(($week1+$week2+$week3)); ?></td>
                                          <?php }elseif ($weekcnt == 4) { ?>
                                          <td class="grossweek" id="gweek0"><?= $week1 ?></td>
                                          <td class="grossweek" id="gweek1"><?= $week2 ?></td>
                                          <td class="grossweek" id="gweek2"><?= $week3 ?></td>
                                          <td class="grossweek" id="gweek3"><?= $week4 ?></td>
                                          <td><?php echo e(($week1+$week2+$week3+$week4)); ?></td>
                                          <?php }elseif ($weekcnt == 5) { ?>
                                          <td class="grossweek" id="gweek0"><?= $week1 ?></td>
                                          <td class="grossweek" id="gweek1"><?= $week2 ?></td>
                                          <td class="grossweek" id="gweek2"><?= $week3 ?></td>
                                          ...
                                          <td><?php echo e(($week1+$week2+$week3+$week4+$week5)); ?></td>
                                          <?php }elseif ($weekcnt == 6) { ?>
                                          <td class="grossweek" id="gweek0"><?= $week1 ?></td>
                                          <td class="grossweek" id="gweek1"><?= $week2 ?></td>
                                          <td class="grossweek" id="gweek2"><?= $week3 ?></td>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td><?php echo e(($week1s+$week2s+$week3s)); ?></td>
                                          <?php }elseif ($weekcnt == 4) { ?>
                                          <td class="otherrweek" id="owee0"><?= $week1s ?></td>
                                          <td class="otherrweek" id="oweek1"><?= $week2s ?></td>
                                          <td class="otherrweek" id="oweek2"><?= $week3s ?></td>
                                          <td class="otherrweek" id="oweek3"><?= $week4s ?></td>
                                          <td><?php echo e(($week1s+$week2s+$week3s+$week4s)); ?></td>
                                          <?php }elseif ($weekcnt == 5) { ?>
                                          <td class="otherrweek" id="oweek0"><?= $week1s ?></td>
                                          <td class="otherrweek" id="oweek1"><?= $week2s ?></td>
                                          <td class="otherrweek" id="oweek2"><?= $week3s ?></td>
                                          ...
                                          <td><?php echo e(($week1s+$week2s+$week3s+$week4s+$week5s)); ?></td>
                                          <?php }elseif ($weekcnt == 6) { ?>
                                          <td class="otherrweek" id="oweek0"><?= $week1s ?></td>
                                          <td class="otherrweek" id="oweek1"><?= $week2s ?></td>
                                          <td class="otherrweek" id="oweek2"><?= $week3s ?></td>
                                       ...
                                       <tr class="total-tr">
                                          ...
                                          <td><?= $week2 + $week2s ?></td>
                                          <td><?= $week3 + $week3s ?></td>
                                          <td><?php echo e(($week1+$week2+$week3+$week1s+$week2s+$week3s)); ?></td>
                                          <?php }elseif ($weekcnt == 4) { ?>
                                          <td><?= $week1 + $week1s ?></td>
                                          <td><?= $week2 + $week2s ?></td>
                                          <td><?= $week3 + $week3s ?></td>
                                          <td><?= $week4 + $week4s ?></td>
                                          <td><?php echo e(($week1+$week2+$week3+$week4+$week1s+$week2s+$week3s+$week4s)); ?></td>
                                          <?php }elseif ($weekcnt == 5) { ?>
                                          <td><?= $week1 + $week1s ?></td>
                                          <td><?= $week2 + $week2s ?></td>
                                          <td><?= $week3 + $week3s ?></td>
                                          <td><?= $week4 + $week4s ?></td>
                                          <td><?= $week5 + $week5s ?></td>
                                          <td><?php echo e(($week1+$week2+$week3+$week4+$week5+$week1s+$week2s+$week3s+$week4s+$week5s)); ?></td>
                                          <?php }elseif ($weekcnt == 6) { ?>
                                          <td><?= $week1 + $week1s ?></td>
                                          <td><?= $week2 + $week2s ?></td>
                                          <td><?= $week3 + $week3s ?></td>
                                 ...
                                 <table class="table table-striped table-bordered table-hover main-table" id="">
                                    ...
                                    <tbody>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td>
                                             <a href="<?php echo e(url('gross_revenue_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <!-- .nk-tb-item  -->
                                       <tr class="odd gradeX">
                                          ...
                                          <td>
                                             <a href="<?php echo e(url('other_revenue_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <!-- .nk-tb-item  -->
                                       <tr class="total-tr">
                                          ...
                                          <td>
                                             <a href="<?php echo e(url('all_revenue_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <!-- .nk-tb-item  -->
                                       <tr>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td><?= $tot ?></td>
                                          <td>
                                             <a href="<?php echo e(url('expense_variance_monthly_graph')); ?>/<?= $value->account_description ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <?php
                                          }
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td>
                                             <a href="<?php echo e(url('expense_variance_monthly_graph')); ?>/<?= $value->name ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <?php } ?>
                                       <tr class="total2-tr">
                                          ...
                                          <td>
                                             <a href="<?php echo e(url('expense_monthly_vary_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                    </tbody>
                                    <tfoot>
                                 ...
                                 <table class="table table-striped table-bordered table-hover main-table" id="">
                                    ...
                                    <tbody>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td><?= $monthgrossactual ?></td>
                                          <td>
                                             <a href="<?php echo e(url('gross_quarter_revenue_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <!-- .nk-tb-item  -->
                                       <tr class="odd gradeX">
                                          ...
                                          <td><?= $monthotherrevenue ?></td>
                                          <td>
                                             <a href="<?php echo e(url('other_quarter_revenue_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <!-- .nk-tb-item  -->
                                       <tr class="total-tr">
                                          ...
                                          <td><?= $monthtotalactual ?></td>
                                          <td>
                                             <a href="<?php echo e(url('all_quarter_revenue_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <!-- .nk-tb-item  -->
                                       <tr>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td><?php echo $actual_total2 = App\Http\Controllers\HomeController::gettotalactualexp($value->name); ?></td>
                                          <td>
                                             <a href="<?php echo e(url('expense_variance_quarterly_graph')); ?>/<?= $value->name ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                       <?php } ?>
                                       <tr class="total2-tr">
                                          ...
                                          <td>
                                             <a href="<?php echo e(url('expense_quarterly_vary_chart')); ?>"><i class="fa fa-bar-chart"></i></a>
                                          </td>
                                       </tr>
                                    </tbody>
                                    <tbody></tbody>
                  ...
                  <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 20px;">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="chart_monthly">
                                          <a href="<?php echo e(url('all_monthly_budget_chart')); ?>"><div id="allbar-chart_total" style="height: 20px;  width: 70px; margin: 0 auto"></div></a>
                                  ...
                                  <tr>
                                      ...
                                      <td class="chart_monthly">
                                          <a href="<?php echo e(url('other_monthly_budget_chart')); ?>"><div id="otherbar-chart_total" style="height: 20px;  width: 70px; margin: 0 auto"></div></a>
                                          <script type="text/javascript">
                                            $(function () {
                                                  "use strict";
                                  ...
                                  <tr class="total-tr">
                                      ...
                                      <td class="chart_monthly">
                                          <a href="<?php echo e(url('total_monthly_budget_chart')); ?>"><div id="bar-chart_total" style="height: 20px;  width: 70px; margin: 0 auto"></div></a>
                                          <script type="text/javascript">
                                            $(function () {
                                                  "use strict";
                     ...
                     ?>
                                          <tr>
                                              ...
                                              <td class="showgraphh" id="showgraphh<?= $value->id ?>">
                                                  <a href="<?php echo e(url('monthly_expense_chart')); ?>/<?= $value->id ?>"><div id="bar-charth<?= $value->id ?>" style="height: 20px; width: 70px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                        $(function () {
                                                              "use strict";
                     ...
                     ?>
                                  <tr class="total-tr">
                                      ...
                                      <td class="chart_monthly">
                                          <a href="<?php echo e(url('total_monthly_expense_chart')); ?>"><div id="bar-chart_totall" style="height: 20px;  width: 70px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                    $(function () {
                                                          "use strict";
                              ...
                              <tfoot>
                                  <tr>
                                      ...
                                      <td class="chart_monthlyy">
                                          <a href="<?php echo e(url('monthly_profit_loss_chart')); ?>"><div id="bar-chart_totally" style="height: 30px;  width: 70px; margin: 0 auto"></div></a>
                                          <script type="text/javascript">
                                            $(function () {
                                                  "use strict";
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td class="chart_quarterly">
                                          <a href="<?php echo e(url('all_quarterly_budget_chart')); ?>"><div id="allbar-chart_quarterlyy" style="height: 20px;  width: 30px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                    $(function () {
                                                          "use strict";
                                                          var bar = new Morris.Bar({
                                  ...
                                  <tr>
                                      ...
                                      <td class="chart_quarterly">
                                          <a href="<?php echo e(url('other_quarterly_budget_chart')); ?>"><div id="otherbar-chart_quarterlyy" style="height: 20px;  width: 30px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                    $(function () {
                                                          "use strict";
                                  ...
                                  <tr class="total-tr">
                                      ...
                                      <td class="chart_quarterly">
                                          <a href="<?php echo e(url('total_quarterly_budget_chart')); ?>"><div id="bar-chart_quarterlyy" style="height: 20px;  width: 30px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                    $(function () {
                                                          "use strict";
                     ...
                     ?>
                                          <tr>
                                              ...
                                              <td class="showgraphqqq" id="showgraphqqq<?= $value->id ?>">
                                                  <a href="<?php echo e(url('quarterly_expense_chart')); ?>/<?= $value->id ?>"><div id="bar-chartqqq<?= $value->id ?>" style="height: 20px; width: 30px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                            $(function () {
                                                                  "use strict";
                     ...
                     ?>
                                  <tr class="total-tr">
                                      ...
                                      <td class="chart_quarterly">
                                          <a href="<?php echo e(url('total_quarterly_expense_chart')); ?>"><div id="bar-chart_quarterllyy" style="height: 20px;  width: 30px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                    $(function () {
                                                          "use strict";
                              ...
                              <tfoot>
                                  <tr>
                                      ...
                                      <td><?= $quaterlytotal - $quaterlytotall ?></td>
                                      <td class="chart_quarterly">
                                          <a href="<?php echo e(url('quarterly_profit_loss_chart')); ?>"><div id="bar-chart_quarterllyyy" style="height: 20px;  width: 30px; margin: 0 auto"></div></a>
                                                  <script type="text/javascript">
                                                    $(function () {
                                                          "use strict";
...
<?php if($weekcnt == 3){ ?>
<input type="hidden" name="" value="<?php echo e($startdates[0]); ?>" id="startdates0">
<input type="hidden" name="" value="<?php echo e($startdates[1]); ?>" id="startdates1">
<input type="hidden" name="" value="<?php echo e($startdates[2]); ?>" id="startdates2">
<input type="hidden" name="" value="<?php echo e($enddates[0]); ?>" id="enddates0">
<input type="hidden" name="" value="<?php echo e($enddates[1]); ?>" id="enddates1">
<input type="hidden" name="" value="<?php echo e($enddates[2]); ?>" id="enddates2">
<?php }elseif ($weekcnt == 4) { ?>
<input type="hidden" name="" value="<?php echo e($startdates[0]); ?>" id="startdates0">
<input type="hidden" name="" value="<?php echo e($startdates[1]); ?>" id="startdates1">
<input type="hidden" name="" value="<?php echo e($startdates[2]); ?>" id="startdates2">
<input type="hidden" name="" value="<?php echo e($startdates[3]); ?>" id="startdates3">
<input type="hidden" name="" value="<?php echo e($enddates[0]); ?>" id="enddates0">
<input type="hidden" name="" value="<?php echo e($enddates[1]); ?>" id="enddates1">
<input type="hidden" name="" value="<?php echo e($enddates[2]); ?>" id="enddates2">
<input type="hidden" name="" value="<?php echo e($enddates[3]); ?>" id="enddates3">
<?php }elseif ($weekcnt == 5) { ?>
<input type="hidden" name="" value="<?php echo e($startdates[0]); ?>" id="startdates0">
<input type="hidden" name="" value="<?php echo e($startdates[1]); ?>" id="startdates1">
<input type="hidden" name="" value="<?php echo e($startdates[2]); ?>" id="startdates2">
<input type="hidden" name="" value="<?php echo e($startdates[3]); ?>" id="startdates3">
<input type="hidden" name="" value="<?php echo e($startdates[4]); ?>" id="startdates4">
<input type="hidden" name="" value="<?php echo e($enddates[0]); ?>" id="enddates0">
<input type="hidden" name="" value="<?php echo e($enddates[1]); ?>" id="enddates1">
<input type="hidden" name="" value="<?php echo e($enddates[2]); ?>" id="enddates2">
<input type="hidden" name="" value="<?php echo e($enddates[3]); ?>" id="enddates3">
<input type="hidden" name="" value="<?php echo e($enddates[4]); ?>" id="enddates4">
<?php } ?>
<script type="text/javascript">
   ...
   $(".grossweek").click(function(){
       ...
       if($(this).html() != 0){
           ...
           $.ajax({
                 ...
                 data: 'startday=' + startday + '&endday=' + endday + '&_token=<?php echo e(csrf_token()); ?>',
                 type: "POST",
               success: function (response) {
                   // alert(response);
   ...
   $(".expenseweek").click(function(){
       ...
       if($(this).html() != 0){
           ...
           $.ajax({
                 ...
                 data: 'startday=' + startday + '&endday=' + endday + '&name=' + name + '&_token=<?php echo e(csrf_token()); ?>',
                 type: "POST",
               success: function (response) {
                   // alert(response);
                   $("#monthly_details3").html(response);
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/profit_loss_stmt.blade.php ENDPATH**/ ?>