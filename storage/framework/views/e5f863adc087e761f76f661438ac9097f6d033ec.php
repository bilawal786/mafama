                        ...
                        <div class="col-md-6 col-md-offset-3 margin-bottom-20">
                            ...
                            <div class="col-md-12 shadow-boxx">
                                ...
                                <div class="col-md-12 text-center padding-0">
                                    ...
                                    <a href="<?php echo e(url('final_appointment')); ?>" class="btn btn-xs btn-info" style="margin-right: 10px; width: 150px;">Confirm Appointment</a>

                                    <a href="<?php echo e(url('appointment_step1')); ?>" class="btn btn-xs btn-info" style="margin-right: 10px; width: 140px;">Change</a>

                                    <a href="<?php echo e(url('/')); ?>" class="btn btn-xs btn-info" style="margin-right: 10px; width: 140px;">Cancel</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/confirm_appointment.blade.php ENDPATH**/ ?>