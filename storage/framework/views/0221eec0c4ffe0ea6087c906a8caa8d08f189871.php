            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-12 margin-bottom-20">
                    ...
                    <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-40">
                        ...
                        <li class="active"><a href="<?php echo e(url('financial_mgmt_invoice_setup')); ?>">Invoice Setup</a></li>
                        <li><a href="<?php echo e(url('balancesheet_template1')); ?>">Balance Sheet</a></li>
                        <li><a href="<?php echo e(url('financial_mgmt_choose_template')); ?>">Activate Accounts</a></li>
                    </ul>
                    ...
                    <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
                        ...
                        <form action="<?php echo e(url('update_financial_invoice_setup')); ?>" method="POST"  enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <h5 class="text-center">To Setup your Invoice, answer the following two questions.</h5>
                                <div class="col-md-6" style="border-radius: 10px; padding-top: 30px; padding-bottom: 20px;">
                                    <div class="row" style="margin: 0px;">
                                        ...
                                        <div class="col-md-9 tax-div" style="display: <?=isset($invoice_setup->id) && ($invoice_setup->is_tax ==2) ?'none':'';?>;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tax_rate" class="form-control" placeholder="Example: .05" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->tax_rate:''); ?>" <?= isset($invoice_setup->id) && ($invoice_setup->is_tax == 1) ?'required':''; ?> />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin: 0px;">
                                        ...
                                        <div class="col-md-9 shipping-div" style="display:  <?=isset($invoice_setup->id) && ($invoice_setup->shipping_cost ==1) ?'block':'none';?>;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="shipping_rate" class="form-control" placeholder="Example: 9.50" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->shipping_rate:''); ?>" <?= isset($invoice_setup->id) && ($invoice_setup->shipping_method== 1) ?'required':''; ?> />
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Enter the Flat Shipping Cost here </label>
                                                <input type="text" name="shipping_amount" class="form-control" placeholder="Example: 15" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->shipping_amount:''); ?>" <?= isset($invoice_setup->id) && ($invoice_setup->shipping_method== 2) ?'required':''; ?>>
                                            </div>
                                    ...
                                    <div class="col-md-12" style="margin-top: 20px; margin-bottom: 20px;">
                                         <input type="hidden" name="id"value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->id:''); ?>" />
                                        <button type="submit" class="btn btn-sm btn-info">Save</button>
                                    </div>
                                </div>
                            </form>

                            <form action="<?php echo e(route('discount_update')); ?>" method="POST" id="dis_form" onsubmit="submit_form()">
                                <?php echo csrf_field(); ?>
                                     ...
                                     <div class="row">
                                         ...
                                         <div style="padding-left:5px !important;padding-right:5px !important" class="col-md-5">
                                                 ...
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                        <?php
                                                            // dd($disc);
                                                        ?>
                                                         <input style="height: 31px !important" class="form-control mrd" type="text" name="per_1" id="input_1" value="<?php echo e($disc->per_1 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr1" type="text" name="per_2" id="input_3" value="<?php echo e($disc->per_2 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr2" type="text" name="per_3" id="input_5" value="<?php echo e($disc->per_3 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr3" type="text" name="per_4" id="input_7" value="<?php echo e($disc->per_4 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr4" type="text" name="per_5" id="input_9" value="<?php echo e($disc->per_5 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                             </div>
                                             ...
                                             <div style="padding-left:5px !important;padding-right:5px !important" class="col-md-5">
                                                 ...
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control mrd1" type="text" name="flat_1" id="input_2" value="<?php echo e($disc->flat_1 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr11" type="text" name="flat_2" id="input_4" value="<?php echo e($disc->flat_2 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr21" type="text" name="flat_3" id="input_6" value="<?php echo e($disc->flat_3 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr31" type="text" name="flat_4" id="input_8" value="<?php echo e($disc->flat_4 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                                 <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                     <div class="">
                                                         <input style="height: 31px !important" class="form-control othr41" type="text" name="flat_5" id="input_10" value="<?php echo e($disc->flat_5 ?? ""); ?>">
                                                     </div>
                                                 </div>
                                             </div>
                                         </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/financial_mgmt_invoice_setup.blade.php ENDPATH**/ ?>