        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-40">
                    <li><a href="<?php echo e(url('revenue_records')); ?>"> Record Revenue</a></li>
                    <li class="active"><a href="<?php echo e(url('expenses_reord')); ?>"> Record Expenses</a></li>
                    ...
                    <div class="col-md-12">
                         ...
                         <div class="row margin-bottom-20">
                            ...
                            <div class="col-md-12 padding-0 text-center margin-bottom-20">
                                ...
                                <a href="<?php echo e(url('expenses_reord')); ?>" class="btn btn-xs btn-info" style="width: 100px;">Cancel</a>
                            </div>
                        </form>
                   ...
                   <div class="expense_records">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatable_sample">
                            <thead>
                                    ...
                                    $balance=0;
                                    ?>
                                    <?php $__currentLoopData = $expense_record; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            $charge +=$value->total;
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(url('edit_expense_record')); ?>/<?= $value->id ?>" class="btn btn-xs btn-info">Edit</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/expenses_reord.blade.php ENDPATH**/ ?>