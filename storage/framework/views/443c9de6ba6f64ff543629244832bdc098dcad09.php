				...
				<div class="nk-block">
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							...
							<?php if(permission_access('templates_financial_add')==1): ?>
								<form id="" action="<?php echo e(url('upload_financial_template_entry')); ?>" method="POST" enctype="multipart/form-data">	
									<?php echo csrf_field(); ?>	
									<div class="row gy-4">
										<div class="col-md-6">
								...
								<table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<!-- <td class="nk-tb-col">
												<span><?php echo e($template->amount); ?></span>
											</td> -->
											<td class="nk-tb-col tb-col-md">
												<?php if(permission_access('templates_financial_edit')==1): ?>
												<a href="<?php echo url('editupload_financial_template') ?>/<?= $template->rid ?>" class="btn btn-sm btn-primary">Edit</a>
												<?php endif; ?>
												<?php if(permission_access('templates_financial_delete')==1): ?>
					...
					<div class="card card-bordered card-stretch">
						<div class="card-inner-group">
							<div class="card-inner card-inner-lg">
								...
								<?php if(permission_access('templates_financial_add')==1): ?>
								<form id="" action="<?php echo e(url('upload_financial_template_entry2')); ?>" method="POST" enctype="multipart/form-data">	
									<?php echo csrf_field(); ?>	
									<div class="row gy-4">
										<div class="col-md-6">
											<div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin_upload_financial_template_category.blade.php ENDPATH**/ ?>