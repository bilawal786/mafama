            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-12 margin-bottom-20">
                    ...
                    <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-40">
                        ...
                        <li class="active"><a href="<?php echo e(url('manage_assets')); ?>">Record / Manage Assets</a></li>
                                ...
                                <tbody>
                                    ...
                                    foreach($record as $value){
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $value->price ?></td>
                                            <td>
                                                <a href="<?php echo e(url('manage_assets_edit')); ?>/<?= $value->id ?>" class="btn btn-xs btn-success">Edit</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/manage_assets.blade.php ENDPATH**/ ?>