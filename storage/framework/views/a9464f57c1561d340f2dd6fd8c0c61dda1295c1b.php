					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<?php if(permission_access('table_level_add')==1): ?>
								<form action="<?php echo e(url('levelentry')); ?>" method="POST" id="">	
									<?php echo csrf_field(); ?>
									<div class="row gy-4">
										<div class="col-md-6">
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												<?php if(permission_access('table_level_edit')==1): ?>
												<a href="<?php echo url('editlevelentry') ?>/<?= $level->id ?>" class="btn btn-sm btn-success">Edit</a>
												<?php endif; ?>
												<?php if(permission_access('table_level_delete')==1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin_level_table.blade.php ENDPATH**/ ?>