<?php $__env->startSection("content"); ?>
                ...
                <div class="col-md-<?php echo e((Auth::id() != "")?9:12); ?> col-sm-<?php echo e((Auth::id() != "")?9:12); ?>">
                    ...
                    <div class="tab-content tab-stacked nav-alternate">
                        <div id="tab_g" class="tab-pane active">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                <div class="owl-carousel text-center owl-testimonial nomargin"
                                                     data-plugin-options='{"items":4, "singleItem": false, "autoPlay": 4000, "navigation": false, "pagination": false, "transitionStyle":"fade"}'>
                                                    <?php
                                                        ...
                                                        <div class="col-md-12 testimonial-bordered">
                                                            ...
                                                            <div class="testimonial-content nopadding">
                                                                ...
                                                                <cite>
                                                                    <?= $slide->username ?>
                                                                    <span
                                                                        class="text-success">New Member</span>
                                                                </cite>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="owl-carousel text-center owl-testimonial nomargin"
                                     data-plugin-options='{"items":1, "singleItem": true, "autoPlay": <?= $slidetime2[0]->playtime ?>, "navigation": false, "pagination": false, "transitionStyle":"fade"}'>
                                    <?php
                                    ...
                                    <div class="col-md-12 col-sm-12 margin-bottom-40">
                                        ...
                                        <a href="<?php echo e($banner->link); ?>" target="_blank">
                                            <img src="<?php echo asset("public/images") ?>/<?= $banner->image ?>" alt=""
                                    ...
                                    <div class="owl-carousel text-center owl-testimonial nomargin"
                                        ...
                                        <div class="col-md-12 col-sm-12 margin-bottom-40">
                                            <div class="embed-responsive embed-responsive-16by9">
                                                ...
                                                <video width="50%" height="450" controls autoplay muted>
                                                    <source src="<?php echo asset("public/videos") ?>/<?= $video->video ?>"
                                                            type="video/mp4">
                                                </video>
                                            </div>
                                        </div>
                                ...
                                <?php if(Auth::check()): ?>
                                    ...
                                    <?php if($transactions->count() >0 ): ?>
                                        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td style="width: 2% !important"><?php echo e($usr->code); ?></td>
                                                <td class="ammt" style="width: 5% !important"><b>$</b><?php echo e($trans->amount); ?></td>
                                                <td>
                                                ...
                                                <td><?php echo e($usr->first_name ?? ""); ?> <?php echo e($usr->last_name ?? ""); ?></td>
                                                <td><?php echo e($usr->country ?? ""); ?></td>
                                                <td style="width: 15% !important"><?php echo e($usr->state ?? ""); ?> <?php echo e($usr->city ?? ""); ?> <?php echo e($usr->commune ?? ""); ?></td>
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="col-md-12">
                            ...
                            <ul style="list-style: none; padding: 0; margin-bottom: 0px">
                                ...
                                ?>
                                <li class="affiliate_popup1" style="padding: 10px; float: left; margin-bottom: 10px;"
                                    id="po<?= $value->id ?>"><?php echo $value->preview; ?></li>
                                <?php
                                }
                                ?>
                            </ul>
                                ...
                                <?php if($mailstatus != ""): ?>
                                            ...
                                            <li>
                                                <label class="checkbox chk-sm">
                                                    <input type="checkbox" value="<?= $value->id ?>"
                                                           class="folder_check"
                                                           <?php if(($value->uid == "default")){ ?> checked <?php } ?> />
                                    ...
                                    <div class="col-md-12 margin-top-20">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" placeholder="To" id="malto"
                                                   name="malto"/>
                                            <div class="email-id-row">
                                                <span class="to-input">To</span>
                                                <div class="all-mail"></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <div class="row">
                        <div class="col-md-12">
                            <div
                                style="padding: 5px; border: 1px solid #da291c; border-radius: 4px; margin-bottom: 20px">
                                <h5>Birthdays</h5>
                                <?php
    ...
    <a href="javascript:void();" class="btn btn-md btn-info margin-right-10 popupmodall" data-toggle="modal"
       data-target="#ex1" style="display: none;"></a>
