        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-40">
                    <li class="active"><a href="<?php echo e(url('revenue_records')); ?>"> Record Revenue</a></li>
                    <li><a href="<?php echo e(url('expenses_reord')); ?>"> Record Expenses</a></li>
                    <li><a href="<?php echo e(url('manage_assets')); ?>">Record / Manage Assets</a></li>
                    <?php if($upload_files != "off"){ ?>
                        <li><a href="<?php echo e(url('upload_files')); ?>">Upload Files</a></li>
                    <?php } ?>
                            ...
                            <form method="POST" id="record_revenue" role="form" enctype="multipart/form-data">
                                ...
                                <div class="margin-bottom-20">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <?php if(count($revenue_account) > 0){ ?>
                                                <input type="number" name="bill" step="0.01" class="form-control" value="<?php if($revenue_account[0]->amount != ""){ echo $revenue_account[0]->amount; }else{ echo 0; } ?>" id="bill" onkeyup="tax_calc()" <?php if($revenue_account[0]->amount != ""){ ?> readonly <?php } ?> required>
                                            <?php }else{ ?>
                                                <input type="number" name="bill" step="0.01" class="form-control" value="0" id="bill" onkeyup="tax_calc()" required>
                                            <?php } ?>
                                        </div>
                                        <div class="col-md-2">
                                            <label>Discount</label>
                                            <input type="number" name="discount" class="form-control" id="discount_field" readonly>
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                        <div class="col-md-3" style="margin-bottom: 20px;<?php echo e($dnone); ?>">
                                            <!--<label>Tax</label>-->
                                            <div style="">
                                                <div class="">
                                                    <label class="checkbox chk-sm ">
                                                        <input class="" type="checkbox" disabled name="tax1" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->tax_rate:0); ?>" <?php if($invoice_setup->is_tax == 1){ ?>checked <?php }else{ ?> readonly <?php } ?> onchange="tax_calc()" />
                                                        <i></i> Tax
                                                    </label>
                                        ...
                                        <div class="col-md-3" style="margin-bottom: 20px;<?php echo e($dnone1); ?>">
                                             <div style="">
                                                 <div class="">
                                                <label class="checkbox chk-sm">
                                                  <input class="" type="checkbox" disabled name="shipping1" value="<?php echo e(isset($invoice_setup->id)?$invoice_setup->shipping_rate:0); ?>" <?php if($invoice_setup->shipping_cost == 1){ ?>checked <?php } else{ ?> readonly <?php } ?> onchange="tax_calc()" />
                                                            <i></i> Shipping
                                        ...
                                        <div class="col-md-2" style="margin-bottom: 20px;">
                                            ...
                                            <input type="number" step="0.01" name="amount_paid" class="form-control" value="0" id="amount_paid" onkeyup="finalize()" required>
                                ...
                                <!-- <div class="col-md-12 padding-0 margin-bottom-20">
                                    ...
                                    <a href="<?php echo e(url('revenue_records')); ?>" class="btn btn-xs btn-info" style="width: 100px;">Cancel</a>
                                </div> -->
                                ...
                                <div class="col-md-12 padding-0 margin-bottom-30">
                                    <div class="" style="display: flex; width:100%">
                                        <div class="mx-auto" style="margin-left: auto; margin-right:auto">
                                            ...
                                            <div>
                                                <button type="submit" class="btn1 info1">Save This Transactions</button>
                                                            ...
                                                            <div style="padding-left:5px !important;padding-right:5px !important" class="col-md-5">
                                                                <div style="padding-left:5px !important;padding-right:5px !important" class="col-md-5">
                                                                    ...
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->per_2 ?? 0); ?> %">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->per_3 ?? 0); ?> %">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->per_4 ?? 0); ?> %">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->per_5 ?? 0); ?> %">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div style="padding-left:5px !important;padding-right:5px !important" class="col-md-5">
                                                                    ...
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->flat_2 ?? 0); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->flat_3 ?? 0); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->flat_4 ?? 0); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group d-flex padding-bottom-0 margin-bottom-10">
                                                                        <div class="">
                                                                            <input style="height: 30px !important" class="form-control" type="text" name="" id="" disabled value="<?php echo e($disc->flat_5 ?? 0); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <?php $__currentLoopData = $months_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valuee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <th id="month_record" data-id="<?php echo e($valuee); ?>" <?php if($cmonth == $valuee): ?> class="active1" <?php endif; ?>><?php echo e(date("M", mktime(0, 0, 0, $valuee, 10))); ?></th>
                          ...
                          <div class="revenue_records">
                            <table class="table table-striped table-borde#da291c table-hover" id="datatable_sample">
                                <thead>
                                    ...
                                    $balance=0;
                                    ?>
                                    <?php $__currentLoopData = $revenue_records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            $charge +=$value->bill;
                                     ...
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="bg-purple">
                                            <th>Total</th>
                                            <th></th>
                                            <th><?php echo e($charge); ?></th>
                                            <th><?php echo e($discount1); ?></th>
                                            <th><?php echo e($tax); ?></th>
                                            <th><?php echo e($shipping); ?></th>
                                            <th><?php echo e($total); ?></th>
                                            <th><?php echo e($amount_paid); ?></th>
                                ...
                                <tbody id="listid">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(($value->account_description != "Sales Tax Collected") && ($value->account_description != "Shipping Collected")): ?>
                                                <a href="<?php echo e(url('edit_revenue_record')); ?>/<?= $value->id ?>" class="btn btn-xs btn-info">Edit</a>
    ...
    function discount_apply() {
        ...
        for(i = 0; i < ele.length; i++) {
                if(ele[i].checked) {
                    ...
                    $.ajax({
                        url: url2,
                        data: 'discount=' + value + '&_token=<?php echo e(csrf_token()); ?>',
                        type: "POST",
                        success: function (response) {
                            ...
                            if (response['type'] == 'flat') {
                                ...
                                var after_discount = before_discount - before_discount*parseFloat(response['value'])/100;
                            }
                            ...
                            var bal = (parseFloat(after_discount)+parseFloat(tax)+parseFloat(shipping) - document.getElementById('amount_paid').value).toFixed(2);
...
<script type="text/javascript">
    $('document').ready(function() {
        <?php if(request()->has('client')): ?>

            $('#client'+<?php echo e(request()->get('client')); ?>).click();
            // alert('#client'+<?php echo e(request()->get('client')); ?>);
        <?php endif; ?>
    })
    ...
    $(".clientss").on("click", function(){
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                data: 'client_email=' + client_email + '&_token=<?php echo e(csrf_token()); ?>',
                type: "POST",
                success: function (response) {
    ...
    $("#delete_revenuee").on('click', function(e){
        ...
        $.ajax({
              ...
              data: 'id=' + id + '&reason=' + delete_reason + '&_token=<?php echo e(csrf_token()); ?>',
              type: "POST",
            success: function (response) {
     ...
     // $(".revenue_records").html("");
        if($(this).html() != 0){
            ...
            $.ajax({
                 ...
                 data: 'month=' + month +'&client_id='+ email +'&_token=<?php echo e(csrf_token()); ?>',
                  type: "POST",
                success: function (response) {
                    // console.log(response);
...
<script>
        $("#bill").keyup(function(){
            ...
            if($("input[name='client123']").is(':checked')){
                ...
                notify("You must select a client FIRST or select “Other revenue”  if a client is not involve in this transaction","warning");
            }
        });
</script>
    ...
    $(document).on('click','.email_invoice',function(){
        ...
        var blnc = $("#balance").val();
            ...
            $.ajax({
                ...
                data: 'invoice_id=' + invoice_id+'month=' + month +'&client_id='+ email+'&date='+ date
                +'&date='+ date
                +'&acc='+ acc
                +'&bill='+ bill
                +'&discount='+ discount
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/revenue_records.blade.php ENDPATH**/ ?>