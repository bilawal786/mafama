		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="row">
					...
					<form  action="<?php echo e(url('add_user_access')); ?>" method="POST" id="" enctype="multipart/form-data">	
					<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/add_user_access_rights.blade.php ENDPATH**/ ?>