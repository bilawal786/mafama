        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <form action="<?php echo e(url('addclient_appointment')); ?>" method="POST" id="" enctype="multipart/form-data" autocomplete="off"><?php echo csrf_field(); ?>
                        <div class="col-md-12" style="border: 1px solid #da291c !important; border-radius: 10px; padding-top: 30px; padding-bottom: 20px;">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center">
                                    <div>
                                        <img src="<?php echo e(asset('public/images/upload.png')); ?>" style="width: 100px; height: 100px; margin: 0 auto; " id="blah">
                                    </div>
                                    <div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/add_client.blade.php ENDPATH**/ ?>