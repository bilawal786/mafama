												...
												<tr class="nk-tb-item">
													...
													<td class="nk-tb-col tb-col-md">
                                                       ...
                                                       <a  data-id="<?= $value->user_id ?>" data-status="1" href="javascript:void(0)" data-msg="Are you sure to activate this account ?" class="btn btn-xs btn-success update_account_status" >Activate</a>
														<?php endif; ?>
														<?php endif; ?>
														<?php if(permission_access('reg_business_delete')==1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin_registered_business.blade.php ENDPATH**/ ?>