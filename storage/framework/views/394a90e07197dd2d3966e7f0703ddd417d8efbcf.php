					...
					<div class="card card-bordered card-stretch">
                        <div class="card-aside-wrap">
							<div class="card-inner card-inner-lg">
								<?php if(permission_access('upload_cards_add')==1): ?>
								<form id="" action="<?php echo e(url('uploadcard_entry')); ?>" method="POST" enctype="multipart/form-data">	
								<?php echo csrf_field(); ?>	
									<div class="row gy-4">
										<div class="col-md-6">
									...
									<tbody>
										...
										<tr class="nk-tb-item">
											...
											<td class="nk-tb-col tb-col-md">
												<?php if(permission_access('upload_cards_edit')==1): ?>
												<a href="<?php echo url('edituploadcard') ?>/<?= $popup->id ?>" class="btn btn-sm btn-primary">Edit</a>
												<?php endif; ?>
												<?php if(permission_access('upload_cards_delete')==1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/admin_upload_card.blade.php ENDPATH**/ ?>