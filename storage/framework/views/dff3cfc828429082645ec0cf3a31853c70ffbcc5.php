        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12">
                    ...
                    <hr />
                    <form action="<?php echo e(url('appointment_additional')); ?>" method="POST" enctype="multipart/form-data">   
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12 margin-bottom-40 margin-top-20">
                            ...
                            <div class="col-md-12 text-center">
                                <a href="<?php echo e(url('appointment_step4')); ?>" class="btn btn-sm btn-info" style="margin-right: 10px; width: 200px; height: 34px">Back</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/appointment_step5.blade.php ENDPATH**/ ?>