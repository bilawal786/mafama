      ...
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12">
            ...
            <ul class="nav nav-tabs nav-button-tabs nav-justified margin-bottom-20">
               <li><a href="<?php echo e(url('profit_loss_stmt')); ?>">Profit / Loss Statement</a></li>
               ...
               <li class="active"><a href="<?php echo e(url('paymentbalance_report')); ?>">Clients With Balance</a></li>
            </ul>
            <div class="tab-content margin-top-10" style="border: 1px solid #da291c !important; border-radius: 10px; padding: 10px;">
               <div class="col-md-12">
                  <ul class="nav nav-tabs nav-button-tabs nav-justified">
                     ...
                     <li><a href="<?php echo e(url('paymentbalance_quaterly_report')); ?>" >Quarterly</a></li>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_editable_1">
                           <thead>
                              ...
                              <tr class="bg-purple" id=
                                 ...
                                 <th><?php echo e($bill_amount1); ?></th>
                                 <th><?php echo e($discount1); ?></th>
                                 <th><?php echo e($tax_amount1); ?></th>
                                 <th><?php echo e($shipping_amount1); ?></th>
                                 <th><?php echo e($total_amount1); ?></th>
                                 <th><?php echo e($paid_amount1); ?></th>
                                 <th><?php echo e($balance_amount1); ?></th>
                              </tr>
                              <tr>
                           ...
                           <tbody id="revenue_records">
                              ...
                              <?php
                                ...
                                <tr class="" style="background: #800080">
                                    ...
                                    <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($bill_amount1); ?></td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($discount1); ?></td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($tax_amount1); ?></td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($shipping_amount1); ?></td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($total_amount1); ?></td>
                                    <td class="fixed-side" style="color:white !important; font-weight:bold"><?php echo e($paid_amount1); ?></td>
                                    <td style="color:white; font-weight:bold" class="fixed-side"><?php echo e(-1*$balance_amount1); ?></td>
                                </tr>
                           </tbody>
                        </table>
                        <div class="row">
   ...
   $(document).on('click','.revenue_month',function(){
       ...
       if($(this).html() != 0){
           ...
           $.ajax({
                 ...
                 data: 'month=' + month + '&email=' + email + '&_token=<?php echo e(csrf_token()); ?>',
                 type: "POST",
               success: function (response) {
                   // alert(response);
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/paymentbalance_report.blade.php ENDPATH**/ ?>