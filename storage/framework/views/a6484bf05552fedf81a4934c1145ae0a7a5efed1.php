            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-button-tabs nav-justified">
                        <li class="active"><a href="<?php echo e(url('manage_clients')); ?>">Client List</a></li>
                        <li><a href="<?php echo e(url('view_client_profiles')); ?>">Profile Details</a></li>
                    </ul>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mafamatest/public_html/resources/views/manage_clients.blade.php ENDPATH**/ ?>