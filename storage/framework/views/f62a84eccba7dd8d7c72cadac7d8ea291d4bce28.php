                                        ...
                                        <table class="table table-striped table-bordered table-hover main-table" id="">
                                           ...
                                           <thead>
                                              ...
                                              <tr class="" style="cursor: pointer">
                                                 <th  class=""></th>
                                                 <th data-month="1" class="<?php echo e((request()->month == 1 ) ? 'active1' : ''); ?> month-clk button-1">Jan</th>
                                                 <th data-month="2" class="<?php echo e((request()->month == 2 ) ? 'active1' : ''); ?> month-clk button-1">Feb</th>
                                                 <th data-month="3" class="<?php echo e((request()->month == 3 ) ? 'active1' : ''); ?> month-clk button-1">Mar</th>
                                                 <th data-month="4" class="<?php echo e((request()->month == 4 ) ? 'active1' : ''); ?> month-clk button-1">Apr</th>
                                                 <th data-month="5" class="<?php echo e((request()->month == 5 ) ? 'active1' : ''); ?> month-clk button-1">May</th>
                                                 <th data-month="6" class="<?php echo e((request()->month == 6 ) ? 'active1' : ''); ?> month-clk button-1">Jun</th>
                                                 <th data-month="7" class="<?php echo e((request()->month == 7 ) ? 'active1' : ''); ?> month-clk button-1">Jul</th>
                                                 <th data-month="8" class="<?php echo e((request()->month == 8 ) ? 'active1' : ''); ?> month-clk button-1">Aug</th>
                                                 <th data-month="9" class="<?php echo e((request()->month == 9 ) ? 'active1' : ''); ?> month-clk button-1">Sep</th>
                                                 <th data-month="10" class="<?php echo e((request()->month == 10 ) ? 'active1' : ''); ?> month-clk button-1">Oct</th>
                                                 <th data-month="11" class="<?php echo e((request()->month == 11 ) ? 'active1' : ''); ?> month-clk button-1">Nov</th>
                                                 <th data-month="12" class="<?php echo e((request()->month == 12 ) ? 'active1' : ''); ?> month-clk button-1">Dec</th>
                                                 <th data-month="all" class="<?php echo e((request()->month == 'all' ) ? 'active1' : ''); ?> month-clk button-1">Total</th>
                                                 <th data-month="graph" class="<?php echo e((request()->month == 'graph' ) ? 'active1' : ''); ?> month-clk button-1">Graph</th>
                                              </tr>
                                            </thead>
                                            ...
                                            <div style="display: flex">
                                                ...
                                                <div class="container bg-white col-md-8 mx-auto">
                                                    ...
                                                    <table>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td style="color:#da291c"><?php echo e($gd['month']); ?></td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div style="width: 400px; display:flex">
                                                                        <div style="border-radius:2px; width: <?php echo e($gd['val']/$max_val * 100); ?>%; background: rgb(<?= implode(",", $rgbColor); ?>); height: 20px;">
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
