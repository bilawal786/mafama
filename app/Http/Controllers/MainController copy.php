...
public function monthlylistfinance(Request $request)
    {
       ...
       $value =2;
        ...
        <tbody id="myTable">
        <tr>
                <td class="fixed-side" style="text-align: left; color: #da291c;"><b>Revenue: &nbsp; &nbsp; &nbsp; &nbsp; ON &nbsp;
                  <input type="radio" id="el" name="Off"  value="On" onchange="show2()"> &nbsp; &nbsp; |&nbsp; &nbsp; OFF &nbsp;
                  <input type="radio" name="Off" value="Off" checked onchange="show(this.value)">&nbsp; &nbsp; |&nbsp; &nbsp; CLR &nbsp;
                  <input type="radio" name="Off" value="clr" onchange="showabc()">
                   </td>
                <td></td>
                <td></td>
                <td></td>
            ...
            if($value== 1){
                ...
                foreach($revenue as $value){
                    ...
                    <tr id="revenue_count_'.$temp.'" class="odd gradeX chang">
            ...
            <tr class="odd gradeX" id="grevenue">
                ...
                echo'
                    <tr class="odd gradeX"  id="grevenue1">
            ...
            echo '
               ...
               ';
                ...
                <tr id="total_r1" class="total-tr">
                    ...
                    <td ><a class="revenue_by_month revenue_by_jan" data-month="01"><b>'.$jantotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_feb" data-month="02"><b>'.$febtotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_mar" data-month="03"><b>'.$martotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_apr" data-month="04"><b>'.$aprtotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_may" data-month="05"><b>'.$maytotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_jun" data-month="06"><b>'.$juntotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_jul" data-month="07"><b>'.$jultotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_aug" data-month="08"><b>'.$augtotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_sep" data-month="09"><b>'.$septotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_oct" data-month="10"><b>'.$octtotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_nov" data-month="11"><b>'.$novtotalactual.'</b></a></td>
                    <td ><a class="revenue_by_month revenue_by_dec" data-month="12"><b>'.$dectotalactual.'</b></a></td>
                    <td class="total-clr"><a class="total_yearly_revenue" ><b>'.$monthtotalactual.'<b></a></td>
                    <td>
            ...
            <tr id="total_r1" class="total-tr">
                <td class="fixed-side" style=""><b>Total Revenue </b></td>
                <td ><a style="font-weight:600" id="jan1" class="revenue_by_month revenue_by_jan" data-month="01"></a></td>
                <td ><a style="font-weight:600" id="feb2" class="revenue_by_month revenue_by_feb" data-month="02"></a></td>
                <td ><a style="font-weight:600" id="mar3" class="revenue_by_month revenue_by_mar" data-month="03"></a></td>
                <td ><a style="font-weight:600" id="apr4" class="revenue_by_month revenue_by_apr" data-month="04"></a></td>
                <td ><a style="font-weight:600" id="may5" class="revenue_by_month revenue_by_may" data-month="05"></a></td>
                <td ><a style="font-weight:600" id="jun6" class="revenue_by_month revenue_by_jun" data-month="06"></a></td>
                <td ><a style="font-weight:600" id="jul7" class="revenue_by_month revenue_by_jul" data-month="07"></a></td>
                <td ><a style="font-weight:600" id="aug8" class="revenue_by_month revenue_by_aug" data-month="08"></a></td>
                <td ><a style="font-weight:600" id="sep9" class="revenue_by_month revenue_by_sep" data-month="09"></a></td>
                <td ><a style="font-weight:600" id="oct10" class="revenue_by_month revenue_by_oct" data-month="10"></a></td>
                <td ><a style="font-weight:600" id="nov11" class="revenue_by_month revenue_by_nov" data-month="11"></a></td>
                <td ><a style="font-weight:600" id="dec12" class="revenue_by_month revenue_by_dec" data-month="12"></a></td>
            ...
            echo '
            <tr class="total2-tr total-tr">
                <td class="fixed-side" style=""><b>Total Expenses</b>  </td>
                <td ><a class="total_expense_by_month total_expanse_jan" data-month="01"><b>'.$jantotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_feb" data-month="02"><b>'.$febtotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_mar" data-month="03"><b>'.$martotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_apr" data-month="04"><b>'.$aprtotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_may" data-month="05"><b>'.$maytotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_jun" data-month="06"><b>'.$juntotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_jul" data-month="07"><b>'.$jultotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_aug" data-month="08"><b>'.$augtotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_sep" data-month="09"><b>'.$septotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_oct" data-month="10"><b>'.$octtotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_nov" data-month="11"><b>'.$novtotal2actual.'</b></a></td>
                <td ><a class="total_expense_by_month total_expanse_dec" data-month="12"><b>'.$dectotal2actual.'</b></a></td>

                <td><a class="total_yearly_expenses" ><b>'.($jantotal2actual + $febtotal2actual + $martotal2actual + $aprtotal2actual + $maytotal2actual + $juntotal2actual + $jultotal2actual + $augtotal2actual + $septotal2actual + $octtotal2actual + $novtotal2actual + $dectotal2actual).'<b></a></td>
