...
Route::get('admin/introduction-videos', 'AdminController@introduction_videos');
...
Route::post('intro_video_update', 'AdminController@intro_video_update');
...
Route::get('renew-plan','MLMHomeController@upgrade_plan');
...
Route::get('introduction_videos/{user_id}/{code}', 'LandingController@introduction_videos');
